...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.informasi.berita')); ?>">Berita</a>
            </div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control <?php echo e(($errors->has('short_content'))?'is-invalid':''); ?>"
                                        name="short_content" value="<?php echo e(old('short_content')); ?>">
                                    <?php if($errors->has('short_content')): ?>
                                    <div class="invalid-feedback">
                                        <?php echo e($errors->first('short_content')); ?>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        class="form-control summernote <?php echo e(($errors->has('content'))?'is-invalid':''); ?>"
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.informasi.berita')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/informasi/berita/create.blade.php ENDPATH**/ ?>