...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.manajemen.admin')); ?>"> Admin</a></div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.manajemen.admin.create')); ?>" class="btn btn-success btn-icon"><i
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($row->roles()->first()->name)??'-'; ?></td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.admin.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.admin.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.manajemen.admin.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.manajemen.admin.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.manajemen.admin')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/manajemen/admin/list.blade.php ENDPATH**/ ?>