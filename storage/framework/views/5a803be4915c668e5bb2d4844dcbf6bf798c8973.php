...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.sksj-create')->html();
} elseif ($_instance->childHasBeenRendered('ZaOAREP')) {
    $componentId = $_instance->getRenderedChildComponentId('ZaOAREP');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZaOAREP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZaOAREP');
} else {
    $response = \Livewire\Livewire::mount('frontend.sksj-create');
    $html = $response->html();
    $_instance->logRenderedChild('ZaOAREP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/frontend/formSurat/sksj.blade.php ENDPATH**/ ?>