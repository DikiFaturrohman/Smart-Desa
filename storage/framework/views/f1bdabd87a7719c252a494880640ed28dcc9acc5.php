...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.dokumen.download')); ?>">Download</a>
            </div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?php echo e(($errors->has('title'))?'is-invalid':''); ?>"
                                        name="title" value="<?php echo e(old('title',$download->title)); ?>">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        id="description"
                                        name="description"><?php echo e(old('description',$download->description)); ?></textarea>
                                </div>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control <?php echo e(($errors->has('file'))?'is-invalid':''); ?>" name="file"
                                        value="<?php echo e(old('file',$download->file)); ?>">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control select2">
                                        <option value="show"
                                            <?php echo e((old('status',$download->status) == 'show')?'selected':''); ?>>Aktif
                                        </option>
                                        <option value="hide"
                                            <?php echo e((old('status',$download->status) == 'hide')?'selected':''); ?>>Tidak
                                            Aktif
                                        </option>
                                    </select>
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.dokumen.download')); ?>" class="btn btn-secondary">Batal</a>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.dokumen.download')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/dokumen/download/edit.blade.php ENDPATH**/ ?>