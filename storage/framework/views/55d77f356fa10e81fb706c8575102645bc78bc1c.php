...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.galeri.foto')); ?>">Foto</a>
            </div>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.galeri.foto')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/galeri/foto/create.blade.php ENDPATH**/ ?>