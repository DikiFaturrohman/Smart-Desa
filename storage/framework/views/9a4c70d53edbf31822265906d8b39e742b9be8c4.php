                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-header">
                            <h4>Form Input Kategori Potensi</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.potensi.kategori')); ?>" class="btn btn-secondary">Batal</a>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.potensi.kategori')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/potensi/kategori/create.blade.php ENDPATH**/ ?>