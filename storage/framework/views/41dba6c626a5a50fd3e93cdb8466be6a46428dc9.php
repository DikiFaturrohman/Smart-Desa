...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.manajemen.menu')); ?>"> Menu</a></div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.manajemen.menu.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        <td><?php echo e($row->modul->name); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.menu.edit',['id' => $row->id])); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.menu.detail',['id' => $row->id])); ?>"
...
<form action="<?php echo e(route('backend.manajemen.menu.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.manajemen.menu.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.manajemen.menu')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/manajemen/menu/list.blade.php ENDPATH**/ ?>