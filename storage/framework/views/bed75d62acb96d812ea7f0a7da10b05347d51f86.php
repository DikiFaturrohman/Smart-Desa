...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.informasi.pengumuman')); ?>">Pengumuman</a>
            </div>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.informasi.pengumuman')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/informasi/pengumuman/create.blade.php ENDPATH**/ ?>