...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.skaw-create')->html();
} elseif ($_instance->childHasBeenRendered('qxunMAq')) {
    $componentId = $_instance->getRenderedChildComponentId('qxunMAq');
    $componentTag = $_instance->getRenderedChildComponentTagName('qxunMAq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qxunMAq');
} else {
    $response = \Livewire\Livewire::mount('frontend.skaw-create');
    $html = $response->html();
    $_instance->logRenderedChild('qxunMAq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<!-- <script src="<?php echo e(asset('frontend/js/savy.min.js')); ?>"></script> -->
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/formSurat/skaw.blade.php ENDPATH**/ ?>