<?php $__env->startSection('title'); ?> Kondisi Geografis Desa <?php $__env->stopSection(); ?>
...
<section class="py-4">
	<div class="container">
		<div class="row">
				<div class="container">
					<h2 class="subjudul-home"><span class="span-judul"><a href="#">Kondisi Geografis Desa</a></span></h2>
				</div>
		</div>
		...
		<div class="row">
				<div class="container">
					<img src="<?php echo e(asset('backend/images/profil/desa/'.$data->foto_desa)); ?>" class="img-fluid rounded" alt="">
						<div class="py-3">
							<?php echo $data->kondisi_geografis; ?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/profil/geografis.blade.php ENDPATH**/ ?>