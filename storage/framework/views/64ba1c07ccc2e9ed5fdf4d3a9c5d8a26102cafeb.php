                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.datamaster.slider')); ?>" class="btn btn-secondary">Batal</a>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/datamaster/slider/create.blade.php ENDPATH**/ ?>