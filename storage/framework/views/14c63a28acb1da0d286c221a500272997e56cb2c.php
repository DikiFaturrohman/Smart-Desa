...
<script>
    $("button").click(function(){
        $('#verifikasiBtn').html('<button class="btn btn-primary btn-progress disabled"></button>')    
    });
                    ...
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control <?php echo e(($errors->has('file'))?'is-invalid':''); ?>" name="file" value="<?php echo e(old('file')); ?>">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/dokumen/download/create.blade.php ENDPATH**/ ?>