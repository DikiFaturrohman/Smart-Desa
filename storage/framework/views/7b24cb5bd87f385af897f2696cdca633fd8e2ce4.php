<?php $__env->startSection('title'); ?> Surat Keterangan Sapu Jagat <?php $__env->stopSection(); ?>
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.dokumen.sksj')); ?>"> Surat Keterangan Sapu Jagat</a></div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List Pengajuan Surat Keterangan Sapu Jagat</h4>
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.dokumen.sksj.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                    <?php $__currentLoopData = $sksj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        <td><?php echo e($row->nama_penduduk); ?></td>
                                        <td><?php echo e($row->no_nik); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.dokumen.sksj.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.dokumen.sksj.print')); ?>" method="post">
...
<form action="<?php echo e(route('backend.dokumen.sksj.kades')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.sksj.sekdes')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.sksj.kasi')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.sksj.delete')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/dokumen/sksj/list.blade.php ENDPATH**/ ?>