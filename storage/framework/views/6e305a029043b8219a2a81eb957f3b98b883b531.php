...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.manajemen.modul')); ?>">Modul</a>
            </div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?php echo e(($errors->has('icon'))?'is-invalid':''); ?>"
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.manajemen.modul')); ?>" class="btn btn-secondary">Batal</a>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.manajemen.modul')); ?>"
</script>
<?php endif; ?>
<?php else: ?>
<script>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/manajemen/modul/create.blade.php ENDPATH**/ ?>