<?php $__env->startSection('title'); ?> Produk BUMDES <?php $__env->stopSection(); ?>
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.informasi.pengumuman')); ?>">Produk</a>
            </div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                  <select name="bumdes_id" id="" class="form-control select2 <?php echo e(($errors->has('bumdes_id'))?'is-invalid':''); ?>" >
                                      <option value="">Pilih BUMDES</option>
                                      <?php $__currentLoopData = $bumdes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($data->id); ?>" <?php echo e((old('bumdes_id')==$data->id)?'selected':''); ?>><?php echo e($data->name); ?></option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </select>
                                  <?php if($errors->has('bumdes_id')): ?>
                                  <div class="invalid-feedback">
                                      <?php echo e($errors->first('bumdes_id')); ?>
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.informasi.pengumuman')); ?>" class="btn btn-secondary">Batal</a>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.bumdes.produk')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/bumdes/produk/create.blade.php ENDPATH**/ ?>