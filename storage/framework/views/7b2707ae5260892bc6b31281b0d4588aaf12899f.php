...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.manajemen.role')); ?>"> Role</a></div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.manajemen.role.create')); ?>" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.role.edit',['id' => $row->id])); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.role.detail',['id' => $row->id])); ?>"
...
<form action="<?php echo e(route('backend.manajemen.role.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.manajemen.role.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.manajemen.role')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/manajemen/role/list.blade.php ENDPATH**/ ?>