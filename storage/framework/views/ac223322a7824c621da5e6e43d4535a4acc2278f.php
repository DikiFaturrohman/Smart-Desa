...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.skbn-create')->html();
} elseif ($_instance->childHasBeenRendered('cSEZf7g')) {
    $componentId = $_instance->getRenderedChildComponentId('cSEZf7g');
    $componentTag = $_instance->getRenderedChildComponentTagName('cSEZf7g');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cSEZf7g');
} else {
    $response = \Livewire\Livewire::mount('frontend.skbn-create');
    $html = $response->html();
    $_instance->logRenderedChild('cSEZf7g', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/frontend/formSurat/skbn.blade.php ENDPATH**/ ?>