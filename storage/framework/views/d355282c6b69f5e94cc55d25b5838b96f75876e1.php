            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List Pengajuan Surat Keterangan Usaha</h4>
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.dokumen.sku.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                    <?php $__currentLoopData = $sku; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.dokumen.sku.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.dokumen.sku.print')); ?>" method="post">
...
<form action="<?php echo e(route('backend.dokumen.sku.delete')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/dokumen/sku/list.blade.php ENDPATH**/ ?>