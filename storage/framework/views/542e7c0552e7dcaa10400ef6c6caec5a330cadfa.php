...
} elseif ($_instance->childHasBeenRendered('119gTtV')) {
    $componentId = $_instance->getRenderedChildComponentId('119gTtV');
    $componentTag = $_instance->getRenderedChildComponentTagName('119gTtV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('119gTtV');
} else {
    $response = \Livewire\Livewire::mount('frontend.skk-create');
    $html = $response->html();
    $_instance->logRenderedChild('119gTtV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/formSurat/skl.blade.php ENDPATH**/ ?>