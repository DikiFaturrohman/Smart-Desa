<?php $__env->startSection('title'); ?> Modul <?php $__env->stopSection(); ?>
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.manajemen.modul')); ?>"> Modul</a></div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.manajemen.modul.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                    <?php $__currentLoopData = $modul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-<?php echo e(($row->status == 1)?'success':'danger'); ?>"><?php echo e(($row->status==1)?'Aktif':'Tidak Aktif'); ?></span>
                                        </td>
                                        <td>
                                            <?php if(Session::get('permission')->update == 1): ?>
                                            <a href="<?php echo e(route('backend.manajemen.modul.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                                class="btn btn-md btn-primary btn-icon" title="Edit"><i
                                                    class="far fa-edit"></i></a>
                                            <?php if($row->status == 1): ?>
                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#inactiveConfirmation"
                                                data-id="<?php echo e($row->encodeHash($row->id)); ?>"
                                                class="ubah btn btn-md btn-danger btn-icon" title="Non Aktifkan"><i
                                                    class="fas fa-power-off"></i></a>
                                            <?php else: ?>
                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#activeConfirmation"
                                                data-id="<?php echo e($row->encodeHash($row->id)); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.modul.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.manajemen.modul.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.manajemen.modul.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.manajemen.modul')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/manajemen/modul/list.blade.php ENDPATH**/ ?>