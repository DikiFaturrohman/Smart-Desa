...
} elseif ($_instance->childHasBeenRendered('3zmGd7n')) {
    $componentId = $_instance->getRenderedChildComponentId('3zmGd7n');
    $componentTag = $_instance->getRenderedChildComponentTagName('3zmGd7n');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3zmGd7n');
} else {
    $response = \Livewire\Livewire::mount('frontend.sku-create');
    $html = $response->html();
    $_instance->logRenderedChild('3zmGd7n', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/frontend/formSurat/sku.blade.php ENDPATH**/ ?>