...
<div class="row py-2 my-2">
	...
	<div class="col-lg-8 col-md-6">
		...
		<div class="container">
			...
			<div class="row">
				<div class="container">
					<h2 class="subjudul-home"><span class="span-judul"><a href="#">Download Data</a></span></h2>
				</div>
			</div>
					...
					<table id="download" class="table table-striped table-bordered" style="width:100%">
						...
						<tbody>
							...
							<?php $__currentLoopData = $download; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>
										<td align="center" valign="top"><?php echo e($i++); ?></td>
										<td> <a href="<?php echo e(route('frontend.download.detail',['slug'=>$data->slug])); ?>"><?php echo e($data->title); ?></a></td>
										<td><?php echo e(\Carbon\Carbon::parse($data->created_at)->translatedFormat('d F Y')); ?></td>
										<td align="center" valign="top">
											<a href="<?php echo e(asset('backend/files/dokumen/download/'.$data->file)); ?>" class="btn btn-gelap"><i class="fas fa-download"></i></a>
										</td>
								</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
						<tfoot>
								<tr>
									<td colspan="4"><?php echo e($download->links('frontend.layout.pagination')); ?></td>
								</tr>
						</tfoot>
					</table>
				</div>
...
<link href="https://cdn.datatables.net/fixedheader/3.1.7/css/fixedHeader.bootstrap.min.css" rel="stylesheet" type="text/css" />
<link href="https://cdn.datatables.net/responsive/2.2.5/css/responsive.bootstrap.min.css" rel="stylesheet" type="text/css" />
<!-- Slick -->
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/download/list.blade.php ENDPATH**/ ?>