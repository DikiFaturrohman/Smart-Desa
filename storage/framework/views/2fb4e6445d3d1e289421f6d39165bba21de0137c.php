...
<section class="py-4">
	<div class="container">
		...
		<div class="row">
              ...
              <?php $__currentLoopData = $pegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="col-md-4 col-xs-12">
                <div class="profile-card-4 text-center">
                  <div style="height:300px auto;object-fit:fill">
                    <img src="<?php echo e(($orang->img)?asset('backend/images/pegawai/'.$orang->img):asset('backend/images/avatar/avatar-1.png')); ?>" class="" style="height:300px">
                  </div>                  
                  <div class="profile-content">
                    <div class="profile-name">
                      <?php echo e($orang->name); ?>

                      <p></p>
                    </div>
                    <div class="profile-description"><strong><?php echo e($orang->position); ?></strong></div>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/frontend/pemdes/perangkat.blade.php ENDPATH**/ ?>