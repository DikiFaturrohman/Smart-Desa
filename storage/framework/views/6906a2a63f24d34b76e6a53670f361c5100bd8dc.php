                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.dokumen.sktm.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                    <?php $__currentLoopData = $sktm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.dokumen.sktm.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.dokumen.sktm.print')); ?>" method="post">
...
<form action="<?php echo e(route('backend.dokumen.sktm.kades')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.sktm.sekdes')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.sktm.kasi')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.sktm.delete')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/dokumen/sktm/list.blade.php ENDPATH**/ ?>