                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-header">
                            <h4>Form Input Potensi</h4>
                        </div>
                        <div class="card-body">
                          <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Kategori</label>
                              <div class="col-sm-9">
                                  <select name="kategori_id" id="" class="form-control select2 <?php echo e(($errors->has('kategori_id'))?'is-invalid':''); ?>" >
                                      ...
                                      <option value="<?php echo e($data->id); ?>" <?php echo e((old('kategori_id')==$data->id)?'selected':''); ?>><?php echo e($data->name); ?></option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </select>
                                  <?php if($errors->has('kategori_id')): ?>
                                  <div class="invalid-feedback">
                                      <?php echo e($errors->first('kategori_id')); ?>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Potensi</label>
                                <div class="col-sm-9">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.potensi.list')); ?>" class="btn btn-secondary">Batal</a>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.potensi.list')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/potensi/list/create.blade.php ENDPATH**/ ?>