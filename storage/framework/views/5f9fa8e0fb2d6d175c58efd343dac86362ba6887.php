...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.dokumen.skk')); ?>"> Surat Keterangan Kelahiran</a></div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.dokumen.skk.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                    <?php $__currentLoopData = $skk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        <td><?php echo e($row->nama_bayi); ?></td>
                                        <td><?php echo e($row->jk_bayi); ?></td>
                                        <td><?php echo e(($row->tgl_lahir_bayi)??'-'); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.dokumen.skk.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.dokumen.skk.print')); ?>" method="post">
...
<form action="<?php echo e(route('backend.dokumen.skk.kades')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.skk.sekdes')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.skk.kasi')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.skk.delete')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/dokumen/skk/list.blade.php ENDPATH**/ ?>