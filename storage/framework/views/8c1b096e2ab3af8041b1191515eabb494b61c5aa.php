<?php $__env->startSection('title'); ?> Sejarah <?php $__env->stopSection(); ?>
...
<section class="py-4">
	<div class="container">
		<div class="row">
				<div class="container">
					<h2 class="subjudul-home"><span class="span-judul"><a href="#">Sejarah</a></span></h2>
				</div>
		</div>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/profil/sejarah.blade.php ENDPATH**/ ?>