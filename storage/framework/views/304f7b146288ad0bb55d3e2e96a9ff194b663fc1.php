<?php $__env->startSection('title'); ?> Slide Banner <?php $__env->stopSection(); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="<?php echo e(route('backend.datamaster.slider.create')); ?>" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="40%"><img width="30%" height="30%" class="img img-fluid"
                                                src="<?php echo e(asset('public/backend/images/slider/'.$row->img)); ?>"></td>
                                        <td width="20%"><?php echo e($row->status); ?></td>
                                        <td width="30%">
                                            <?php if(Session::get('permission')->update == 1): ?>
                                            <a href="<?php echo e(route('backend.datamaster.slider.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                                class="btn btn-md btn-primary btn-icon" title="Edit"><i
                                                    class="far fa-edit"></i></a>
                                            <?php endif; ?>
                                            <?php if(Session::get('permission')->delete == 1): ?>
...
<form action="<?php echo e(route('backend.datamaster.slider.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.datamaster.slider.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.datamaster.slider.delete')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/datamaster/slider/list.blade.php ENDPATH**/ ?>