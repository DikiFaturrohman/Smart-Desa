...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.manajemen.user')); ?>"> User</a></div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.manajemen.user.create')); ?>" class="btn btn-success btn-icon"><i
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-<?php echo e(($row->is_verified == 1)?'success':'danger'); ?>"><?php echo e(($row->is_verified==1)?'Aktif':'Tidak Aktif'); ?></span>
                                        </td>
                                        <td>
                                            <?php if(Session::get('permission')->update == 1): ?>
                                            <a href="<?php echo e(route('backend.manajemen.user.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.manajemen.user.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.manajemen.user.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.manajemen.user.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.manajemen.user')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/manajemen/user/list.blade.php ENDPATH**/ ?>