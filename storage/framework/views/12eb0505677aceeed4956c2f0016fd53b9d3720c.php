<?php $__env->startSection('title'); ?> Galeri Foto <?php $__env->stopSection(); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.galeri.foto.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                  ...
                                  $i = 1;
                                  ?>
                                  <?php $__currentLoopData = $fotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <tr>
                                      <td><?php echo e($i++); ?></td>
                                      <td><?php echo e($row->title); ?></td>
                                      <td><?php echo e($row->img); ?></td>
                                      <td><?php echo e($row->status); ?></td>
                                      <td>
                                        <?php if(Session::get('permission')->update == 1): ?>
                                        <a href="<?php echo e(route('backend.galeri.foto.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                        ...
                                        <a href="<?php echo e(route('backend.galeri.foto.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.galeri.foto.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.galeri.foto.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/galeri/foto/list.blade.php ENDPATH**/ ?>