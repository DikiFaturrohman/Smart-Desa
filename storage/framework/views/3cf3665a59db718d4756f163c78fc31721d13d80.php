<?php $__env->startSection('title'); ?> Info Grafis Desa <?php $__env->stopSection(); ?>
...
<div class="row py-2 my-2">
	...
	<div class="col-lg-8 col-md-6">
		...
		<div class="container">
			...
			<?php if($grafis->count() == 0): ?>
				<center><h2 class="py-2">Belum ada data</h2></center><hr>
			<?php else: ?>
			<?php $__currentLoopData = $grafis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			<div class="sidelist shadow">
				...
				<div class="row">
					...
					<div class="col-md-4 img-container">
							...
							<img class="img-side-fit" width="100%" src="<?php echo e(($row->img)?asset('backend/images/informasi/infoGrafis/'.$row->img):asset('backend/images/default.jpg')); ?>" alt="<?php echo e(($row->title)); ?>"/>						
					...
					<div class="col-md-7 px-2 py-2">
						...
						<h5 class="pt-1">
							...
							<a href="<?php echo e(route('frontend.infografis.detail',['slug'=>$row->slug])); ?>" class="">
						...
						<p class="text-justify f1-s-5">
							...
							<?php echo e($row->short_content); ?>&nbsp;<a href="<?php echo e(route('frontend.infografis.detail',['slug'=>$row->slug])); ?>" class="badge badge-secondary"> more....</a>
		...
		<div class="pt-3">
			...
			<?php if(!empty($grafis)): ?>
				<?php echo e($grafis->links('frontend.layout.pagination')); ?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/infoGrafis/list.blade.php ENDPATH**/ ?>