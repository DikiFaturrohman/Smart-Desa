<?php $__env->startSection('title'); ?> Profil BUMDES <?php $__env->stopSection(); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Profil Badan Usaha Milik Desa</h4>
                        <div class="card-header-action">
                          <?php if(Session::get('permission')->create == 1): ?>
                          <a href="<?php echo e(route('backend.bumdes.profil.create')); ?>" class="btn btn-success btn-icon"><i class="fas fa-plus-circle"></i> Tambah</a>
                          <?php endif; ?>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="<?php echo e(route('backend.bumdes.profil.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                        ...
                                        <a href="<?php echo e(route('backend.bumdes.profil.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.bumdes.profil.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.bumdes.profil.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/bumdes/profil/list.blade.php ENDPATH**/ ?>