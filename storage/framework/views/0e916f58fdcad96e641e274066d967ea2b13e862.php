                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.informasi.agenda.create')); ?>" class="btn btn-success btn-icon"><i
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(\Carbon\Carbon::parse($row->start_date)->translatedFormat('d M Y H:m')); ?></td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.informasi.agenda.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.informasi.agenda.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.informasi.agenda.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.informasi.agenda.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.informasi.agenda')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/informasi/agenda/list.blade.php ENDPATH**/ ?>