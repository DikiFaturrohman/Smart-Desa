...
} elseif ($_instance->childHasBeenRendered('RMM3Zpk')) {
    $componentId = $_instance->getRenderedChildComponentId('RMM3Zpk');
    $componentTag = $_instance->getRenderedChildComponentTagName('RMM3Zpk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RMM3Zpk');
} else {
    $response = \Livewire\Livewire::mount('frontend.skm-create');
    $html = $response->html();
    $_instance->logRenderedChild('RMM3Zpk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/frontend/formSurat/skm.blade.php ENDPATH**/ ?>