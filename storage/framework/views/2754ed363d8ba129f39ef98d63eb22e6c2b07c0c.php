...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.manajemen.menu')); ?>">Menu</a>
            </div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="modul_id" class="form-control select2">
                                        ...
                                        <?php $__currentLoopData = $modul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($data->id); ?>" <?php echo e((old('modul_id') == $data->id)?'selected':''); ?>>
                                            <?php echo e($data->name); ?>

                                        </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <?php if($errors->has('modul_id')): ?>
                                    <div class="invalid-feedback">
                                        <?php echo e($errors->first('modul_id')); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control <?php echo e(($errors->has('route'))?'is-invalid':''); ?>"
                                        name="route" value="<?php echo e(old('route')); ?>">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.manajemen.menu')); ?>" class="btn btn-secondary">Batal</a>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.manajemen.menu')); ?>"
</script>
<?php endif; ?>
<?php else: ?>
<script>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/manajemen/menu/create.blade.php ENDPATH**/ ?>