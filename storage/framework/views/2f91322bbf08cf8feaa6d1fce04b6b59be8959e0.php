...
<div class="row py-2 my-2">
    ...
    <div class="col-lg-8 col-md-6">
        ...
        <div class="container">
            ...
            <?php else: ?>
            <?php $__currentLoopData = $foto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="sidelist shadow">
                <div class="row">
                    <div class="col-md-4 img-container">
                        <img class="img-to-fit" width="100%"
                            src="<?php echo e(($row->img)?asset('backend/images/galeri/foto/'.$row->img):asset('backend/images/default.jpg')); ?>" alt="<?php echo e(($row->title)); ?>" />
                    </div>
                    <div class="col-md-7 px-2 py-2">
                        ...
                        <h5 class="pt-1">
                            <a href="<?php echo e(route('frontend.foto.detail',['slug'=>$row->slug])); ?>" class="">
        ...
        <div class="pt-3">
            ...
            <span></span>
            <?php else: ?>
            <?php echo e($foto->links('frontend.layout.pagination')); ?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/foto/list.blade.php ENDPATH**/ ?>