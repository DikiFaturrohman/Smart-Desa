                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.dokumen.download.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                    <?php $__currentLoopData = $download; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        <td><?php echo e($row->title); ?></td>
                                        <td>
                                            <?php if($row->file): ?>
                                            <a href="<?php echo e(asset('backend/files/download/'.$row->file)); ?>" target="_blank"><?php echo e($row->file); ?>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-<?php echo e(($row->status == 'show')?'success':'danger'); ?>"><?php echo e(($row->status=='show')?'Aktif':'Tidak Aktif'); ?></span>
                                        </td>
                                        <td>
                                            <?php if(Session::get('permission')->update == 1): ?>
                                            <a href="<?php echo e(route('backend.dokumen.download.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.dokumen.download.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.dokumen.download.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.dokumen.download.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.dokumen.download')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/backend/dokumen/download/list.blade.php ENDPATH**/ ?>