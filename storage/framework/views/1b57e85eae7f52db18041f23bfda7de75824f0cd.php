<?php $__env->startSection('title'); ?> Tambah BUMDES <?php $__env->stopSection(); ?>
...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item"><a href="<?php echo e(route('backend.bumdes.profil')); ?>"> Profil</a></div>
                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-header">
                            <h4>Form Input Profil BUMDES</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-right">
                            <a href="<?php echo e(route('backend.bumdes.profil')); ?>" class="btn btn-secondary">Batal</a>
...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('backend.bumdes.profil')); ?>"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/bumdes/profil/create.blade.php ENDPATH**/ ?>