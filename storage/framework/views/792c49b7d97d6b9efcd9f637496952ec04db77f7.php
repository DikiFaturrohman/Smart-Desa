                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.galeri.video.create')); ?>" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="<?php echo e(route('backend.galeri.video.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                        ...
                                        <a href="<?php echo e(route('backend.galeri.video.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.galeri.video.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.galeri.video.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/galeri/video/list.blade.php ENDPATH**/ ?>