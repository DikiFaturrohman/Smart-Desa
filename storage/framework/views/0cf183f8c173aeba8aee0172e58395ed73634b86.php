<?php $__env->startSection('title'); ?> Berita <?php $__env->stopSection(); ?>
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.informasi.berita')); ?>"> Berita</a></div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.informasi.berita.create')); ?>" class="btn btn-success btn-icon"><i
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($row->short_content); ?></td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.informasi.berita.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                            ...
                                            <a href="<?php echo e(route('backend.informasi.berita.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.informasi.berita.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.informasi.berita.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<!-- <form action="<?php echo e(route('backend.informasi.berita')); ?>" method="post" enctype="multipart/form-data">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/informasi/berita/list.blade.php ENDPATH**/ ?>