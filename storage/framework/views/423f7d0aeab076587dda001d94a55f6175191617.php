...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?php echo e(route('backend.dokumen.skm')); ?>"> Surat Keterangan Kematian</a></div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>List Pengajuan Surat Keterangan Kematian</h4>
                        <div class="card-header-action">
                            ...
                            <a href="<?php echo e(route('backend.dokumen.skm.create')); ?>" class="btn btn-success btn-icon"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    ?>
                                    <?php $__currentLoopData = $skm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($i++); ?></td>
                                        <td><?php echo e($row->nik_jenazah); ?></td>
                                        <td><?php echo e($row->nama_jenazah); ?></td>
                                        <td><?php echo e(\Carbon\Carbon::parse($row->tgl_lahir_jenazah)->translatedFormat('d M Y')); ?></td>
                                        <td><?php echo e(\Carbon\Carbon::parse($row->tgl_kematian)->translatedFormat('d M Y')); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('backend.dokumen.skm.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.dokumen.skm.print')); ?>" method="post">
...
<form action="<?php echo e(route('backend.dokumen.skm.kades')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.skm.sekdes')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.skm.kasi')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<form action="<?php echo e(route('backend.dokumen.skm.delete')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/dokumen/skm/list.blade.php ENDPATH**/ ?>