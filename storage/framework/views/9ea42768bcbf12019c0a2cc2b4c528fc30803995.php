            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Produk-produk Badan Usaha Milik Desa</h4>
                        <div class="card-header-action">
                            <?php if(Session::get('permission')->create == 1): ?>
                            <a href="<?php echo e(route('backend.bumdes.produk.create')); ?>" class="btn btn-success btn-icon"><i class="fas fa-plus-circle"></i> Tambah</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo e($row->bumdes->name); ?></td>
                                      <td><?php echo e($row->status); ?></td>
                                      <td>
                                        <?php if(Session::get('permission')->update == 1): ?>
                                        <a href="<?php echo e(route('backend.bumdes.produk.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                        ...
                                        <a href="<?php echo e(route('backend.bumdes.produk.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.bumdes.produk.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.bumdes.produk.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/bumdes/produk/list.blade.php ENDPATH**/ ?>