<?php $__env->startSection('title'); ?> Kepala Desa <?php $__env->stopSection(); ?>
...
<section class="py-4">
	<div class="container">
		<div class="row">
				<div class="container">
					<h2 class="subjudul-home"><span class="span-judul"><a href="#">Kepala Desa</a></span></h2>
				</div>
		</div>
		<div class="row">
				<div class="container">
						<div class="py-2 my-2">
							<div class="row">
								<div class="col-md-4 pr-4">
									<img class="img-fluid rounded" src="<?php echo e(($profil->foto_kades)?asset('backend/images/profil/kades/'.$profil->foto_kades):asset('backend/images/avatar/avatar-1.png')); ?>" alt="<?php echo e($profil->kades); ?>">
								</div>
								<div class="col-md-8">
									<h2><?php echo e($profil->kades); ?></h2>
									<hr>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/pemdes/kades.blade.php ENDPATH**/ ?>