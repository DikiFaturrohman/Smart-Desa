<?php $__env->startSection('title'); ?> Agenda Desa <?php $__env->stopSection(); ?>
...
<div class="row py-2 my-2">
    ...
    <div class="col-lg-8 col-md-6">
            ...
            <div class="card mb-1">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="container">
                                ...
                                <small class="text-white">
                                    ...
                                    <i
                                        class="fa fa-calendar-alt"></i>&nbsp;<?php echo e(\Carbon\Carbon::parse($row->created_at)->translatedFormat('d F Y')); ?>&nbsp;|&nbsp;
                                ...
                                <div class="tablistjudul">
                                    ...
                                    <h5 class="judulagenda">
                                        ...
                                        <a data-toggle="collapse" href="#collapse-<?php echo e($i); ?>" aria-expanded="true"
                                            aria-controls="collapse-<?php echo e($i); ?>" id="heading-<?php echo e($i); ?>" class="d-block">
                ...
                <div id="collapse-<?php echo e($i); ?>" class="collapse" aria-labelledby="heading-<?php echo e($i); ?>">
                    ...
                    <div class="card-body">
                        ...
                        <i
                            class="fa fa-clock"></i>&nbsp;<?php echo e(\Carbon\Carbon::parse($row->start_date)->translatedFormat('h.i')); ?>

                        - <?php echo e(\Carbon\Carbon::parse($row->end_date)->translatedFormat('h.i')); ?> WIB

                        <br><i class="fa fa-calendar-alt"></i>&nbsp;

                        <?php echo e(\Carbon\Carbon::parse($row->start_date)->translatedFormat('d F Y')); ?> -
                        <?php echo e(\Carbon\Carbon::parse($row->end_date)->translatedFormat('d F Y')); ?>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('frontend.agenda.detail',['slug'=>$row->slug])); ?>"
        ...
        <div class="pt-3">
            ...
            <?php echo e($agendas->links('frontend.layout.pagination')); ?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/frontend/agenda/list.blade.php ENDPATH**/ ?>