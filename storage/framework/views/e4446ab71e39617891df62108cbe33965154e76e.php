<?php $__env->startSection('title'); ?> <?php echo e((Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'); ?> <?php echo e(ucwords(strtolower(Session::get('nama_desa')))); ?> Kabupaten Subang <?php $__env->stopSection(); ?>
...
<section>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-lg-12 col-sm-12 px-5 py-4 bg-white wow">
            ...
            <form action="<?php echo e(route('frontend.hubungikami.kirim')); ?>" method="post">
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\smartdesa\resources\views/frontend/bukuTamu.blade.php ENDPATH**/ ?>