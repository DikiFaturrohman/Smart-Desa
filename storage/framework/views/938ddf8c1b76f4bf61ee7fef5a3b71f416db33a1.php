<?php $__env->startSection('title'); ?> BUMDES <?php $__env->stopSection(); ?>
...
<div class="row py-2 my-2">
	...
	<div class="col-lg-8 col-md-6">
		...
		<div class="container">
			...
			<?php if($bumdes->count() == 0): ?>
				<center><h2 class="py-2">Belum ada data</h2></center><hr>
			<?php else: ?>
			<?php $__currentLoopData = $bumdes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			<div class="sidelist shadow">
				...
				<div class="row">
					...
					<div class="col-md-4 img-container">
							...
							<img class="img-side-fit" width="100%" src="<?php echo e(($row->img)?asset('backend/images/bumdes/profil/'.$row->img):asset('backend/images/default.jpg')); ?>" alt="<?php echo e(($row->name)); ?>"/>
					...
					<div class="col-md-7 px-2 py-2">
						...
						<small class="f1-s-3">
							...
							<i class="fa fa-calendar-alt"></i>&nbsp;<?php echo e(\Carbon\Carbon::parse($row->created_at)->translatedFormat('l, d F Y')); ?>&nbsp;|&nbsp;
						...
						<h5 class="pt-1">
							...
							<a href="<?php echo e(route('frontend.bumdes.profil.detail',['slug'=>$row->slug])); ?>" class="">
						...
						<p class="text-justify f1-s-5">
							...
							<?php echo e($row->short_description); ?>&nbsp;<a href="<?php echo e(route('frontend.bumdes.profil.detail',['slug'=>$row->slug])); ?>" class="badge badge-secondary"> Selengkapnya....</a>
		...
		<div class="pt-3">
			...
			<?php if(!empty($bumdes)): ?>
				<?php echo e($bumdes->links('frontend.layout.pagination')); ?>
                                                        ...
                                                        <div class="row">
                                                                <div class="col-md-4 img-container">
                                                                        <img class="img-to-fit" width="100%"
                                                                                src="<?php echo e(asset('backend/images/informasi/pengumuman/'.$tabpengumuman->img)); ?>"
                                                                ...
                                                                <div class="row py-1">
                                                                        <div class="col-md-12 col-sm-12">
                                                                                ...
                                                                                <div class="card mb-1">
                                                                                                                        ...
                                                                                                                        <div class="tablistjudul">
                                                                                                                                <h5 class="judulagenda">
                                                                                                                                        <a data-toggle="collapse"
                                                                                                                                                href="#agenda-<?php echo e($i); ?>" aria-expanded="true"
                                                                                        ...
                                                                                        <div id="agenda-<?php echo e($i); ?>" class="collapse"
                                                                                                aria-labelledby="head-<?php echo e($i); ?>">
                                                                                                <div class="card-body">
                                                                                                        <table>
                                                                                                                <tr>
                                        ...
                                        <div class="tab-pane active" id="berita" role="tabpanel">
                                                ...
                                                <div class="sidelist shadow">
                                                        <div class="row">
                                                                <div class="col-md-4 img-container">
                                                                        <img class="img-to-fit" width="100%"
                                                                                src="<?php echo e(asset('backend/images/informasi/berita/'.$tabberita->img)); ?>"
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/frontend/bumdes/profil/list.blade.php ENDPATH**/ ?>