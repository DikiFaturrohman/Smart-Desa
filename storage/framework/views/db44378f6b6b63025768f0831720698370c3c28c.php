<?php $__env->startSection('title'); ?> Kategori Potensi <?php $__env->stopSection(); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                          ...
                          <a href="<?php echo e(route('backend.potensi.kategori.create')); ?>" class="btn btn-success btn-icon"><i class="fas fa-plus-circle"></i> Tambah</a>
                          <?php endif; ?>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="<?php echo e(route('backend.potensi.kategori.edit',['id' => $row->encodeHash($row->id)])); ?>"
                                        ...
                                        <a href="<?php echo e(route('backend.potensi.kategori.detail',['id' => $row->encodeHash($row->id)])); ?>"
...
<form action="<?php echo e(route('backend.potensi.kategori.active')); ?>" method="post">
...
<form action="<?php echo e(route('backend.potensi.kategori.inactive')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\app\resources\views/backend/potensi/kategori/list.blade.php ENDPATH**/ ?>