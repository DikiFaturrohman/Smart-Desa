...
<center><h3>Pengajuan Surat Keterangan Penghasilan</h2></center>
    ...
    <!-- content -->
    <form method="post" action="" enctype="multipart/form-data" id="mainform" wire:submit.prevent="update">
        {{csrf_field()}}
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_slip_gaji)
                    <img src="{{asset('storage/backend/images/dokumen/skp/slip_gaji/'.$file_slip_gaji)}}" alt=""
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    <img src="{{asset('storage/backend/images/dokumen/skp/surat_pernyataan/'.$file_surat_pernyataan)}}"
