    ...
    <form id="mainform" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-12 table-responsive">
            <table id="tableData1" class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td>
                            <input type="text" name="nama_pasangan[]" class="form-control {{$errors->has('nama_pasangan.0')?'is-invalid':''}}" wire:model="nama_pasangan.0">
                        </td>
                        <td><input type="text" name="tempat_lahir_pasangan[]" class="form-control {{$errors->has('tempat_lahir_pasangan.0')?'is-invalid':''}}"
                                wire:model="tempat_lahir_pasangan.0"></td>
                        <td><input type="date" name="tgl_lahir_pasangan[]" class="form-control {{$errors->has('tgl_lahir_pasangan.0')?'is-invalid':''}}"
                                wire:model="tgl_lahir_pasangan.0"></td>
                        <td><select name="jk_pasangan[]" id="" class="form-control {{$errors->has('jk_pasangan.0')?'is-invalid':''}}" wire:model="jk_pasangan.0">
                                <option value="">Pilih Jenis Kelamin</option>
                        ...
                        <td>
                            <select name="pekerjaan_id[]" id="" class="form-control {{$errors->has('pekerjaan_id.0')?'is-invalid':''}}" wire:model="pekerjaan_id.0">
        ...
        <div class="col-sm-12 table-responsive">
            <table id="tableData" class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" name="nama_anak[]" class="form-control {{$errors->has('nama_anak.0')?'is-invalid':''}}" wire:model="nama_anak.0">
                        </td>
                        <td><input type="text" name="tempat_lahir_anak[]" class="form-control {{$errors->has('tempat_lahir_anak.0')?'is-invalid':''}}" wire:model="tempat_lahir_anak.0"></td>
                        <td><input type="date" name="tgl_lahir_anak[]" class="form-control {{$errors->has('tgl_lahir_anak.0')?'is-invalid':''}}" wire:model="tgl_lahir_anak.0"></td>
                        <td><select name="kewarganegaraan[]" id="" class="form-control {{$errors->has('kewarganegaraan.0')?'is-invalid':''}}" wire:model="kewarganegaraan.0">
                        ...
                        <td><input type="text" name="alamat_anak[]" class="form-control {{$errors->has('alamat_anak.0')?'is-invalid':''}}" wire:model="alamat_anak.0"></td>
                        <td>
