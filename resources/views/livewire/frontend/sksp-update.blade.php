        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_sp_rtrw)
                    <img src="{{asset('storage/backend/images/dokumen/skn/rtrw/'.$file_sp_rtrw)}}" alt="" width="200px"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_akta_cerai)
                    <img src="{{asset('storage/backend/images/dokumen/skn/akta_cerai/'.$file_akta_cerai)}}" alt=""
