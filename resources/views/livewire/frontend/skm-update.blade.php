        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_ktp_alm)
                    <img src="{{asset('storage/backend/images/dokumen/skm/ktp_alm/'.$file_ktp_alm)}}" alt=""
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_ktp_pelapor)
                    <img src="{{asset('storage/backend/images/dokumen/skm/ktp_pelapor/'.$file_ktp_pelapor)}}" alt=""
                        width="200px" height="200px" style="margin-top:7px"><br>
                    @endif
                    <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_ktp_saksi)
                    <img src="{{asset('storage/backend/images/dokumen/skm/ktp_saksi/'.$file_ktp_saksi)}}" alt=""
                        width="200px" height="200px" style="margin-top:7px"><br>
                    @endif
                    <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_sk_rs)
                    <img src="{{asset('storage/backend/images/dokumen/skm/sk_rs/'.$file_sk_rs)}}" alt=""
                        width="200px" height="200px" style="margin-top:7px"><br>
                    @endif
                    <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                </div>
