<div class="container py-3">
    <center>
        <h3>Pengajuan Surat Keterangan Kelahiran</h2>
    </center>
    <div class="line"></div>
    <!-- content -->
        ...
        <div class="form-group row row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_kk)
                    <img src="{{asset('storage/backend/images/dokumen/skk/kk/'.$file_kk)}}" alt="" width="200px"
        ...
        <div class="form-group row row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_ibu)
                    <img src="{{asset('storage/backend/images/dokumen/skk/file_ibu/'.$file_ibu)}}" alt="" width="200px"
                        height="200px" style="margin-top:7px"><br>
                    @endif
                    <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                </div>
        ...
        <div class="form-group row row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_ayah)
                    <img src="{{asset('storage/backend/images/dokumen/skk/file_ayah/'.$file_ayah)}}" alt=""
        ...
        <div class="form-group row row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_surat_nikah)
                    <img src="{{asset('storage/backend/images/dokumen/skk/surat_nikah/'.$file_surat_nikah)}}" alt=""
                        width="200px" height="200px" style="margin-top:7px"><br>
                    @endif
                    <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                </div>
        ...
        <div class="form-group row row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    @endif
                    @if($file_sk_kelahiran)
                    <img src="{{asset('storage/backend/images/dokumen/skk/sk_kelahiran/'.$file_sk_kelahiran)}}" alt=""
                        width="200px" height="200px" style="margin-top:7px"><br>
                    @endif
                    <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                </div>
        ...
        <div class="form-group row row">
            ...
            <div class="col-sm-8 pl-2">
                <input type="text" name="nama_kepala_keluarga" id="nama_kepala_keluarga"
                    ...
                    wire:model="nama_kepala_keluarga" value="{{old('nama_kepala_keluarga')}}"
                    placeholder="Silahkan untuk masukan nama kepala keluarga" />
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <textarea id="alamat_ibu" name="alamat_ibu" type="text"
                    class="form-control {{$errors->has('alamat_ibu')?'is-invalid':''}}" wire:model="alamat_ibu"
                    placeholder="Silahkan untuk masukan alamat lengkap">{{old('alamat_ibu')}}</textarea>
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label" for="wni">
                            <input type="radio" class="form-check-input" id="wni" name="kewarganegaraan_ibu" value="wni"
                                {{(old('kewarganegaraan_ibu')=='wni')?'checked':''}}
                                wire:model="kewarganegaraan_ibu">WNI
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label" for="wna">
                            <input type="radio" class="form-check-input" id="wna" name="kewarganegaraan_ibu" value="wna"
                                {{(old('kewarganegaraan_ibu')=='wna')?'checked':''}}
                                wire:model="kewarganegaraan_ibu">WNA
                        </label>
                    </div><br>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <textarea id="alamat_ayah" name="alamat_ayah" type="text"
                    class="form-control {{$errors->has('alamat_ayah')?'is-invalid':''}}" wire:model="alamat_ayah"
                    placeholder="Silahkan untuk masukan alamat">{{old('alamat_ayah')}}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="checkbox">
                    <div class="form-check-inline">
                        <label class="form-check-label" for="wni">
                            <input type="radio" class="form-check-input" id="wni" name="kewarganegaraan_ayah"
                                wire:model="kewarganegaraan_ayah" value="wni"
                                {{(old('kewarganegaraan_ayah')=='wni')?'checked':''}}>WNI
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label" for="wna">
                            <input type="radio" class="form-check-input" id="wna" name="kewarganegaraan_ayah"
                                wire:model="kewarganegaraan_ayah" value="wna"
                                {{(old('kewarganegaraan_ayah')=='wna')?'checked':''}}>WNA
                        </label>
                    </div><br>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <input id="kebangsaan_ayah" name="kebangsaan_ayah" type="text"
                    ...
                    wire:model="kebangsaan_ayah" value="{{old('kebangsaan_ayah')}}"
                    placeholder="Silahkan untuk masukan kebangsaan">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <textarea id="alamat_pelapor" name="alamat_pelapor" type="text"
                    class="form-control {{$errors->has('alamat_pelapor')?'is-invalid':''}}" wire:model="alamat_pelapor"
                    placeholder="Silahkan untuk masukan alamat">{{old('alamat_pelapor')}}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <textarea id="alamat_saksi1" name="alamat_saksi1" type="text"
                    class="form-control {{$errors->has('alamat_saksi1')?'is-invalid':''}}" wire:model="alamat_saksi1"
                    placeholder="Silahkan untuk masukan alamat">{{old('alamat_saksi1')}}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <textarea id="alamat_saksi2" name="alamat_saksi2" type="text"
                    class="form-control {{$errors->has('alamat_saksi2')?'is-invalid':''}}" wire:model="alamat_saksi2"
                    placeholder="Silahkan untuk memasukan alamat">{{old('alamat_saksi2')}}</textarea>
