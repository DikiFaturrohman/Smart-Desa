    ...
    <form method="post" enctype="multipart/form-data" id="mainform">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_surat_pernyataan" alt=""
                    width="200px" style="margin-top:7px"><br>
                <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <textarea class="form-control" rows="3" id="alamat_orangtua" name="alamat_orangtua"
                    placeholder="Masukkan alamat lengkap beserta RT/RW nya">{{old('alamat_orangtua')}}</textarea>
