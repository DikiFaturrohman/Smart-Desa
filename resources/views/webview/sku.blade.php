    ...
    <form action="" method="post" enctype="multipart/form-data" id="mainform">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    ...
                    <input type="file" class="custom-file-input" name="file_sp_rtrw" id="file_sp_rtrw"><br>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input class="form-control" id="" name="jenis_usaha" placeholder="" value="{{old('jenis_usaha')}}">
