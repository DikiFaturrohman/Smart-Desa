...
<form method="post" action="" enctype="multipart/form-data" id="mainform">
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
            ...
            <input type="hidden" name="suket_id" value="{{$skp->id}}">
			...
			<?php $img = asset('backend/images'); ?>
                <img src="<?php echo (!empty($skp->slip_gaji) ? $img . '/dokumen/skp/slip_gaji/' . $skp->slip_gaji : $img . '/default.jpg') ?>"
                    id="preview-file_slip_gaji" style="width: 200px;margin-top:7px"><br>
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<?php $img = asset('backend/images'); ?>
                <img src="<?php echo (!empty($skp->file_ktp) ? $img . '/dokumen/skp/ktp/' . $skp->file_ktp : $img . '/default.jpg') ?>"
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<?php $img = asset('backend/images'); ?>
                <img src="<?php echo (!empty($skp->file_kk) ? $img . '/dokumen/skp/kk/' . $skp->file_kk : $img . '/default.jpg') ?>"
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<?php $img = asset('backend/images'); ?>
                <img src="<?php echo (!empty($skp->file_surat_pernyataan) ? $img . '/dokumen/skp/surat_pernyataan/' . $skp->file_surat_pernyataan : $img . '/default.jpg') ?>"
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" value="{{old('nik',$skp->nik)}}" readonly>
			@if($errors->has('nik'))
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" value="{{old('nama',$skp->nama)}}" readonly>
			@if($errors->has('nama'))
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input type="text" class="form-control" id="" name="tempat_lahir" placeholder="" value="{{old('tempat_lahir',$skp->tempat_lahir)}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input type="date" class="form-control" name="tgl_lahir" value="{{old('tgl_lahir',$skp->tgl_lahir)}}" readonly/>
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
	        ...
	        <label class="form-check-label" for="laki-laki">
	          ...
	          <input type="radio" class="form-check-input" id="laki-laki" name="jk" value="laki-laki" {{(old('jk',$skp->jk)=='laki-laki')?'checked':''}}>Laki-laki
	      ...
	      <div class="form-check-inline">
	        ...
	        <label class="form-check-label" for="perempuan">
	          ...
	          <input type="radio" class="form-check-input" id="perempuan" name="jk" value="perempuan" {{(old('jk',$skp->jk)=='perempuan')?'checked':''}}>Perempuan
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			<select id="pekerjaan_id" name="pekerjaan_id" class="auto-save form-control">
				...
				<option value="{{$data->id}}" {{(old('pekerjaan_id',$skp->pekerjaan_id)==$data->id)?'selected':''}}>{{$data->nama}}</option>
				@endforeach
			</select>
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input class="form-control" id="" name="pekerjaan_lainnya" placeholder="Diisi jika pilihan pekerjaan 'Lainnya'">
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<textarea class="form-control" rows="3" id="" name="alamat" placeholder="Masukkan alamat lengkap beserta RT/RW nya" readonly>{{old('alamat',$skp->alamat)}}</textarea>
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input type="number" min="0" class="form-control" id="" name="jumlah_tanggungan" placeholder="Jumlah orang yang ditanggung dalam keluarga" value="{{old('jumlah_tanggungan',$skp->jumlah_tanggungan)}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input type="number" min="0" class="form-control" id="" name="nominal" placeholder="Nominal angka" value="{{old('nominal',$skp->gaji)}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 pl-2">
			...
			<input type="text" class="form-control" id="" name="terbilang" placeholder="Jumlah penghasilan terbilang" value="{{old('terbilang',$skp->terbilang)}}">
