    ...
    <form method="post" action="" enctype="multipart/form-data" id="mainform">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_akta_cerai" alt="" width="200px"
                    style="margin-top:7px"><br>
                <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="date" name="tgl_lahir" class="form-control"
                    value="{{old('tgl_lahir',$user->tgl_lahir)}}" readonly/>
                    ...
                    <div class="form-check-inline">
                        ...
                        <label class="form-check-label" for="laki-laki">
                            ...
                            <input type="radio" class="form-check-input" id="laki-laki" name="jk" value="laki-laki"
                                {{(old('jk',$user->jenis_kelamin)=='laki-laki')?'checked':''}}>Laki-laki
                    ...
                    <div class="form-check-inline">
                        ...
                        <label class="form-check-label" for="perempuan">
                            ...
                            <input type="radio" class="form-check-input" id="perempuan" name="jk" value="perempuan"
                                {{(old('jk',$user->jenis_kelamin)=='perempuan')?'checked':''}}>Perempuan
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <select id="status_nikah" name="status_nikah" class="auto-save form-control">
                    ...
                    <option value="lajang" {{(old('status_nikah')=='lajang')?'selected':''}}>Belum Menikah</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input class="form-control" id="keperluan" name="keperluan"
                    placeholder="Surat Keterangan ini dibuat untuk keperluan ?" value="{{old('keperluan')}}">
