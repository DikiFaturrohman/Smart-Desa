    ...
    <form method="post" id="mainform" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9 pl-2">
                ...
                <input type="hidden" name="suket_id" value="{{$skbn->id}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9 pl-2">
                <select id="jenis_dok" name="jenis_dok[]" class="dok_1 auto-save form-control">
                    ...
                    <option value="ktp" {{(old('jenis_dok.0',$skbn->skbnDetail[0]->jenis_dok)=='ktp')?'selected':''}}>KTP</option>
                    <option value="sim" {{(old('jenis_dok.0',$skbn->skbnDetail[0]->jenis_dok)=='sim')?'selected':''}}>SIM</option>
                    <option value="ijazah" {{(old('jenis_dok.0',$skbn->skbnDetail[0]->jenis_dok)=='ijazah')?'selected':''}}>Ijazah</option>
                    <option value="kk" {{(old('jenis_dok.0',$skbn->skbnDetail[0]->jenis_dok)=='kk')?'selected':''}}>Kartu Keluarga</option>
                    <option value="akta nikah" {{(old('jenis_dok.0',$skbn->skbnDetail[0]->jenis_dok)=='akta nikah')?'selected':''}}>Akta Nikah</option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" class="form-control" id="nomor_dok" name="nomor_dok[]"
                    placeholder="Masukkan Nomor Dokumen 1" value="{{old('nomor_dok.0',$skbn->skbnDetail[0]->nomor_dok)}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" class="form-control" id="nama_salah" name="nama_dok[]"
                    placeholder="Masukkan Nama dari Jenis Dokumen 1" value="{{old('nama_dok.0',$skbn->skbnDetail[0]->nama_dok)}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9 pl-2">
                <select id="jenis_dok" name="jenis_dok[]" class="dok_2 auto-save form-control">
                    ...
                    <option value="ktp" {{(old('jenis_dok.1',$skbn->skbnDetail[1]->jenis_dok)=='ktp')?'selected':''}}>KTP</option>
                    <option value="sim" {{(old('jenis_dok.1',$skbn->skbnDetail[1]->jenis_dok)=='sim')?'selected':''}}>SIM</option>
                    <option value="ijazah" {{(old('jenis_dok.1',$skbn->skbnDetail[1]->jenis_dok)=='ijazah')?'selected':''}}>Ijazah</option>
                    <option value="kk" {{(old('jenis_dok.1',$skbn->skbnDetail[1]->jenis_dok)=='kk')?'selected':''}}>Kartu Keluarga</option>
                    <option value="akta nikah" {{(old('jenis_dok.1',$skbn->skbnDetail[1]->jenis_dok)=='akta nikah')?'selected':''}}>Akta Nikah</option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" class="form-control" id="nomor_dok" name="nomor_dok[]"
                    placeholder="Masukkan Nomor Dokumen 2" value="{{old('nomor_dok.1',$skbn->skbnDetail[1]->nomor_dok)}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <input type="text" class="form-control" id="nama_salah" name="nama_dok[]"
                    placeholder="Masukkan Nama dari Jenis Dokumen 2" value="{{old('nama_dok.1',$skbn->skbnDetail[1]->nama_dok)}}">
                ...
                <div class="pt-2">
                    ...
                    <div class="form-check-inline">
                        ...
                        <label class="form-check-label">
                            ...
                            <input type="radio" class="value_dok_1 form-check-input" name="data_dok_benar"
                                value="{{$skbn->skbnDetail[0]->jenis_dok}}" {{($skbn->skbnDetail[0]->jenis_dok == $skbn->data_dok_benar)?'checked':''}}>Dokumen 1
                        </label>
                    ...
                    <div class="form-check-inline">
                        ...
                        <label class="form-check-label">
                            ...
                            value="{{$skbn->skbnDetail[1]->jenis_dok}}" {{($skbn->skbnDetail[1]->jenis_dok == $skbn->data_dok_benar)?'checked':''}}>Dokumen 2
