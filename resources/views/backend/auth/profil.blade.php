...
@section('bottom-resource')
<link rel="stylesheet" href="{{asset('public/backend/node_modules/bootstrap-social/bootstrap-social.css')}}">
@endsection
    ...
    <div class="section-body">
        <div class="row mt-sm-4">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <form method="post" action="{{route('backend.profil.update')}}" class="needs-validation" novalidate="" enctype="multipart/form-data" id="mainform">
                        {{csrf_field()}}
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    <label>Nama</label>
                                    <input type="text" class="form-control {{($errors->has('name'))?'is-invalid':''}}" value="{{$profil->name}}" name="name">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control {{($errors->has('phone_number'))?'is-invalid':''}}" value="{{$profil->phone_number}}" name="phone_number">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <label>Alamat</label>
                                    <textarea type="text" id="description" name="address" class="form-control summernote {{($errors->has('address'))?'is-invalid':''}}" value="">{{$profil->address}}</textarea>
