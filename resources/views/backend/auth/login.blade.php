...
<head>
    ...
    <link rel="stylesheet" href="{{asset('backend/node_modules/izitoast/dist/css/iziToast.min.css')}}">
...
<body>
    <!-- <div class="preloader">
        <div class="loading">
            <img src="{{asset('backend/images/loading.gif')}}" width="125">
            <p>Harap Tunggu</p>
        </div>
    </div> -->
                            ...
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="text" class="form-control {{($errors->has('username'))?'is-invalid':''}}" name="username"
                                            placeholder="Masukan Email atau Username" value="{{old('username')}}" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="pass_log_id" type="password" class="form-control {{($errors->has('password'))?'is-invalid':''}}" name="password"
                                    ...
                                    <div class="form-group">
                                        <label class="refereshrecapcha">{!! captcha_img('flat') !!}</label>
                                ...
                                <div class="text-job text-muted">Didukung oleh : </div>
                                    <img src="{{asset('backend/images/diskominfo.png')}}" alt="" width="100px">
                                    <img src="{{asset('backend/images/logo-bsre.png')}}" alt="" width="100px">
                            	</div>
                        </center>
    ...
    <!-- JS Libraies -->
    <script src="{{asset('backend/node_modules/izitoast/dist/js/iziToast.min.js')}}"></script>

    <!-- Page Specific JS File -->
    <script src="{{asset('backend/js/page/modules-toastr.js')}}"></script>
    <!-- Template JS File -->
