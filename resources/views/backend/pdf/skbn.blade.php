    ...
    <div class="halaman">
        ...
        <div class="isi">
            ...
            <p>
                <table style="padding-left: 30px;">
                    ...
                    <tr>
                        <td>Jabatan</td>
                        <td>:</td>
                        <td>{{($desa->desa->kecamatan->id == '2018110602402')?'Lurah':'Kepala Desa'}}
                    ...
                    <tr>
                        ...
                        <td>{{($desa->desa->kecamatan->id == '2018110602402')?'Kelurahan':'Desa'}}
                            {{($desa)?ucwords(strtolower($desa->nama)):ucwords(strtolower($desa->desa->nama))}}
                            Kecamatan {{ucwords(strtolower($desa->desa->kecamatan->nama))}}</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
            ...
            <p>
                <ol>
                    <li>
                        Nama yang tercantum di {{strtoupper($skbn->skbnDetail[0]->jenis_dok)}} dengan No:
                        {{$skbn->skbnDetail[0]->nomor_dok}} adalah:
                        <table>
                            <tr>
                                <td style="width: 30%;">Nama</td>
                                <td style="width: 10px">:</td>
                    ...
                    <li>
                        Sedangkan Nama yang tercantum di {{strtoupper($skbn->skbnDetail[1]->jenis_dok)}} dengan No:
                        {{$skbn->skbnDetail[1]->nomor_dok}} adalah:
                        <table>
                            <tr>
                                <td style="width: 30%;">Nama</td>
                                <td style="width: 10px">:</td>
            ...
            <p>Dengan adanya perbedaan nama tersebut, kami menegaskan bahwa orangnya sama dan berdasarkan pengakuan dari
                yang bersangkutan, nama yang akan digunakan adalah nama yang tercantum di
                {{strtoupper($skbn->data_dok_benar)}} dengan No: {{$dataBenar->nomor_dok}} yaitu nama:<br></p>
                        ...
                        <td style="width: 45%;">
                            <table style="border-bottom: 1px solid #000;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10px">:</td>
                                    <td style="width: 70%;">
                                        {{\Carbon\Carbon::parse($skbn->finished_date)->translatedFormat('d F Y')}}</td>
                                </tr>
                            </table>
                            <br>
                        </td>
            ...
            <table>
                <tr>
                    <td style="width:10%"><span><img src="data:image/png;base64, {!! base64_encode($barcode) !!}"
                                width="auto" height="45px"></span></td>
