                    ...
                    <td width="25%" style="border-right:1px #000 dashed;" valign="top">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{($desa)?ucwords(strtolower($desa->nama)):ucwords(strtolower($desa->desa->nama))}}
                                </td>
                            </tr>
                        </table>
                        <br><br><br>
                        <p class="tengah">ARSIP UNTUK
                            {{($desa->desa->kecamatan->id == '2018110602402')?'KELURAHAN':'DESA'}}</p>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{\Carbon\Carbon::parse($skm->tgl_lahir_jenazah)->translatedFormat('d F Y')}} /
                                    {{\Carbon\Carbon::parse($skm->tgl_lahir_jenazah)->diffInYears()}}</td>
                            </tr>
                            <tr>
                                <td>Agama</td>
                                <td>:</td>
                                ...
                                <td style="border: 1px #000 solid;">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td colspan="4">
                                                {{\Carbon\Carbon::parse($skm->tgl_lahir_jenazah)->translatedFormat('d F Y')}}
                                                / {{\Carbon\Carbon::parse($skm->tgl_lahir_jenazah)->diffInYears()}}</td>
                                        </tr>
                                        <tr>
                                            <td>5.</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td>b. Kecamatan {{ucwords(strtolower($skm->kecamatanJenazah->nama))??'-'}}
                                            </td>
                                            <td></td>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>a.
                                                ...
                                                {{ucwords(strtolower($skm->areaAyah->nama))??'-'}}</td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td>b. Kecamatan {{ucwords(strtolower($skm->kecamatanAyah->nama))??'-'}}
                                            </td>
                                            <td></td>
                                ...
                                <td style="border: 1px #000 solid;">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>a.
                                                {{($desa->desa->kecamatan->id == '2018110602402')?'Kelurahan':'Desa'}}
                                                {{ucwords(strtolower($skm->areaIbu->nama))??'-'}}</td>
                                            <td></td>
