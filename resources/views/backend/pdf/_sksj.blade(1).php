        ...
        <div class="isi">
            ...
            <p>
                ...
                <ol>
                    ...
                    <li style="margin-bottom: 10px;">Dan orang tersebut diatas telah menghadap kami untuk membuat Surat Keterangan yang akan digunakan untuk:<br><center>{{$sksj->keperluan}}</center></li>
