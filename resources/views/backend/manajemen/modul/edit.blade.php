...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{route('backend.manajemen.modul')}}">Guru</a>
            </div>
                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        id="description" name="description">{{$modul->description}}</textarea>
                                </div>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control select2">
                                        <option value="1" {{($modul->status == 1)?'selected':''}}>Aktif
                                        </option>
                                        <option value="0" {{($modul->status == 0)?'selected':''}}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                        ...
                        <div class="card-footer text-right">
                            <a href="{{route('backend.manajemen.modul')}}" class="btn btn-secondary">Batal</a>
...
@else
<script>
    window.location.href = "{{route('backend.manajemen.modul')}}"
