                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.manajemen.user.create')}}" class="btn btn-success btn-icon"><i
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-{{($row->is_verified == 1)?'success':'danger'}}">{{($row->is_verified==1)?'Aktif':'Tidak Aktif'}}</span>
                                        </td>
                                        <td>
                                            @if(Session::get('permission')->update == 1)
                                            <a href="{{route('backend.manajemen.user.edit',['id' => $row->encodeHash($row->id)])}}"
                                            ...
                                            <a href="{{route('backend.manajemen.user.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.manajemen.user.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.manajemen.user.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
...
<!-- <form action="{{route('backend.manajemen.user')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
