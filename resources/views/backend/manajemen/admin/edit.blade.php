...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{route('backend.manajemen.admin')}}">Admin</a>
            </div>
                    ...
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('nik'))?'is-invalid':''}}"
                                        name="nik" value="{{old('nik',$admin->nik)}}">
                                    @if($errors->has('nik'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control {{($errors->has('confirmation_password'))?'is-invalid':''}}"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="desa_id" class="form-control select2 {{($errors->has('desa_id'))?'is-invalid':''}}" >
                                        <option value="">Pilih Desa/Kelurahan</option>
                                        @foreach($desa as $data)
                                        <option value="{{$data->id}}" {{(old('desa_id',$admin->desa_id) == $data->id)?'selected':''}}>
                                            {{$data->nama}} - {{$data->kecamatan->nama}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        id="description" name="address">{{$admin->address}}</textarea>
                                </div>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="<?php echo (!empty($admin->img) ? $img . '/manajemen/admin/' . $admin->img : $img . '/avatar/avatar-1.png') ?>"
                                        id="preview-img" style="width: 200px">
                                    <input type="file" class="form-control {{($errors->has('img'))?'is-invalid':''}}"
                                        id="img" name="img" value="{{$admin->img}}"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="role" class="form-control select2 {{($errors->has('role'))?'is-invalid':''}}" >
                                        ...
                                        <option value="{{$role->id}}" {{($admin->roles->first()->id == $role->id)?'selected':''}}>
                                            @if(Session::get('kecamatan_id') == '2018110602402')
                                                @if($role->id == 'operator')
                                                    Operator Kelurahan
                                                @elseif($role->id == 'kasi')
                                                    Kasi Kelurahan
                                                @elseif($role->id == 'sekretaris_desa')
                                                    Sekretaris Lurah
                                                @elseif($role->id == 'kepala_desa')
                                                    Lurah
                                                @endif
                                            @else
                                                {{$role->name}}
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control select2">
                                        <option value="1" {{($admin->status == 1)?'selected':''}}>Aktif
                                        </option>
                                        <option value="0" {{($admin->status == 0)?'selected':''}}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                        ...
                        <div class="card-footer text-right">
                            <a href="{{route('backend.manajemen.admin')}}" class="btn btn-secondary">Batal</a>
...
@else
<script>
    window.location.href = "{{route('backend.manajemen.admin')}}"
