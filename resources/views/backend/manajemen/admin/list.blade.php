                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.manajemen.admin.create')}}" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('backend.manajemen.admin.edit',['id' => $row->encodeHash($row->id)])}}"
                                            ...
                                            <a href="{{route('backend.manajemen.admin.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.manajemen.admin.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.manajemen.admin.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
...
<!-- <form action="{{route('backend.manajemen.admin')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
