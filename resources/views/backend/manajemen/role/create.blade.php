                                    ...
                                    <table class="table table-striped table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="read[]" id="read-{{$menu->id}}" class="crud-{{$menu->id}}" readonly>
                                                        <option value="{{$menu->id}}">Y</option>
                                                        <option value="0" selected>N</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select name="create[]" id="create-{{$menu->id}}" class="crud-{{$menu->id}}" readonly>
                                                        <option value="{{$menu->id}}">Y</option>
                                                        <option value="0" selected>N</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select name="update[]" id="update-{{$menu->id}}" class="crud-{{$menu->id}}" readonly>
                                                        <option value="{{$menu->id}}">Y</option>
                                                        <option value="0" selected>N</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select name="delete[]" id="delete-{{$menu->id}}" class="crud-{{$menu->id}}" readonly>
                                                        <option value="{{$menu->id}}">Y</option>
                                                        <option value="0" selected>N</option>
                                                    </select>
                                                </td>
