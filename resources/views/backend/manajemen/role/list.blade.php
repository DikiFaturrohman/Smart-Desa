                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.manajemen.role.create')}}" class="btn btn-success btn-icon"><i
                            ...
                            <table class="table table-striped table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-{{($row->status == 1)?'success':'danger'}}">{{($row->status==1)?'Aktif':'Tidak Aktif'}}</span>
                                        </td>
                                        <td>
                                            @if(Session::get('permission')->update == 1)
                                            <a href="{{route('backend.manajemen.role.edit',['id' => $row->id])}}"
                                            ...
                                            <a href="{{route('backend.manajemen.role.detail',['id' => $row->id])}}"
...
<form action="{{route('backend.manajemen.role.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.manajemen.role.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
...
<!-- <form action="{{route('backend.manajemen.role')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
