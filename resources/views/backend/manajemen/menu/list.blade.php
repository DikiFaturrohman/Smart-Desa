                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.manajemen.menu.create')}}" class="btn btn-success btn-icon"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('backend.manajemen.menu.edit',['id' => $row->id])}}"
                                            ...
                                            <a href="{{route('backend.manajemen.menu.detail',['id' => $row->id])}}"
...
<form action="{{route('backend.manajemen.menu.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.manajemen.menu.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
...
<!-- <form action="{{route('backend.manajemen.menu')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
