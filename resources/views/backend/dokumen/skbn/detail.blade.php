                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <a href="{{asset('backend/images/dokumen/skbn/rtrw/'.$skbn->file_sp_rtrw)}}"
                                    target="_blank">
                                    <img src="{{asset('backend/images/dokumen/skbn/rtrw/'.$skbn->file_sp_rtrw)}}"
                                        width="200px"></a>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <a href="{{asset('backend/images/dokumen/skbn/ktp/'.$skbn->file_ktp)}}"
                                    target="_blank"><img
                                        src="{{asset('backend/images/dokumen/skbn/ktp/'.$skbn->file_ktp)}}"
                                        width="200px"></a>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <a href="{{asset('backend/images/dokumen/skbn/kk/'.$skbn->file_kk)}}" target="_blank"
                                    width="200px"><img src="{{asset('backend/images/dokumen/skbn/kk/'.$skbn->file_kk)}}"
                                        width="200px"></a>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <a href="{{asset('backend/images/dokumen/skbn/surat_pernyataan/'.$skbn->file_surat_pernyataan)}}"
                                    target="_blank" width="200px"><img
                                        src="{{asset('backend/images/dokumen/skbn/surat_pernyataan/'.$skbn->file_surat_pernyataan)}}"
                                        width="200px"></a>
                            </div>
                        </div>
                    </div>
