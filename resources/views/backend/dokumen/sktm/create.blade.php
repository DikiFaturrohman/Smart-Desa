                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="post" enctype="multipart/form-data" id="mainform">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" min="0"
                                        ...
                                        placeholder="Masukan NIK Anda" name="nik" value="{{old('nik')}}">
                                    @if($errors->has('nik'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('nik')}}
                                    </div>
                                ...
                                <div class="col-sm-9">
                                    <select
                                        ...
                                        <option value="indonesia"
                                            {{ ( old('warga_negara') == 'indonesia') ? 'selected' : '' }}>Indonesia
                                        </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('nama_ayah'))?'is-invalid':''}}"
                                        placeholder="Masukan Nama Ayah Anda" name="nama_ayah" value="{{old('nama_ayah')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('nama_ibu'))?'is-invalid':''}}"
                                        placeholder="Masukan Nama Ibu Anda" name="nama_ibu" value="{{old('nama_ibu')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="alamat_orangtua" id="" rows="3"
                                        class="form-control {{($errors->has('alamat_orangtua'))?'is-invalid':''}}">{{old('alamat_orangtua')}}</textarea>
                            ...
                            <div class="card-footer text-right">
                                <a href="{{route('backend.dokumen.sktm')}}" class="btn btn-secondary">Batal</a>
