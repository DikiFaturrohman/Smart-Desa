                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-header">
                            <h4>Form Edit Kategori Potensi</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('short_description'))?'is-invalid':''}}"
                                        name="short_description" value="{{old('short_description',$kategori->short_description)}}">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        id="description" name="description">{{old('description',$kategori->description)}}</textarea>
                                </div>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control select2">
                                        <option value="show" {{(old('status',$kategori->status) == 'show')?'selected':''}}>Aktif
                                        </option>
                                        <option value="hide" {{(old('status',$kategori->status) == 'hide')?'selected':''}}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                        ...
                        <div class="card-footer text-right">
                            <a href="{{route('backend.potensi.kategori')}}" class="btn btn-secondary">Batal</a>
...
@else
<script>
    window.location.href = "{{route('backend.potensi.kategori')}}"
