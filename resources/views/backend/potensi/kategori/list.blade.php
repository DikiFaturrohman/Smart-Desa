...
@section('title') Kategori Potensi @endsection
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                          ...
                          <a href="{{route('backend.potensi.kategori.create')}}" class="btn btn-success btn-icon"><i class="fas fa-plus-circle"></i> Tambah</a>
                          @endif
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="{{route('backend.potensi.kategori.edit',['id' => $row->encodeHash($row->id)])}}"
                                        ...
                                        <a href="{{route('backend.potensi.kategori.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.potensi.kategori.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.potensi.kategori.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
...
<!-- <form action="{{route('backend.informasi.pengumuman')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
