...
@section('title') Potensi @endsection
                ...
                <div class="card">
                    <form method="post" enctype="multipart/form-data" id="mainform">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" class="form-control {{($errors->has('name'))?'is-invalid':''}}"
                                        name="name" value="{{old('name',$potensi->name)}}">
                                    @if($errors->has('name'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('name')}}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control {{($errors->has('short_description'))?'is-invalid':''}}"
                                        name="short_description" value="{{old('short_description',$potensi->short_description)}}">
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea type="text"
                                        ...
                                        id="description" name="description">{{old('description',$potensi->description)}}</textarea>
                                </div>
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="<?php echo (!empty($potensi->img) ? $img . '/potensi/' . $potensi->img : $img . '/default.jpg') ?>"
                                        id="preview-img" style="width: 200px">
                                    <input type="file" class="form-control {{($errors->has('img'))?'is-invalid':''}}"
                                        id="img" name="img" value="{{$potensi->img}}"
                            ...
                            <div class="form-group mb-0 row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control select2">
                                        <option value="show" {{(old('status',$potensi->status) == 'show')?'selected':''}}>Aktif
                                        </option>
                                        <option value="hide" {{(old('status',$potensi->status) == 'hide')?'selected':''}}>Tidak
                                            Aktif
                                        </option>
                                    </select>
                        ...
                        <div class="card-footer text-right">
                            <a href="{{route('backend.potensi.list')}}" class="btn btn-secondary">Batal</a>
...
@else
<script>
    window.location.href = "{{route('backend.potensi.list')}}"
