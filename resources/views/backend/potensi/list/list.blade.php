                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            ...
                            <a href="{{route('backend.potensi.list.create')}}" class="btn btn-success btn-icon"><i class="fas fa-plus-circle"></i> Tambah</a>
                            @endif
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="{{route('backend.potensi.list.edit',['id' => $row->encodeHash($row->id)])}}"
                                        ...
                                        <a href="{{route('backend.potensi.list.detail',['id' => $row->encodeHash($row->id)])}}"
...
<form action="{{route('backend.potensi.list.active')}}" method="post">
    {{csrf_field()}}
...
<form action="{{route('backend.potensi.list.inactive')}}" method="post">
    {{csrf_field()}}
    <input type="hidden" class="id" value="" name="id">
