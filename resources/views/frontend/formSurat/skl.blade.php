            ...
            <div class="list-group-item py-3" data-acc-step>
                ...
                <div data-acc-content>
                    ...
                    style="margin-top:7px"><br>
                        ...
                        <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ibu" alt="" width="200px"
                    style="margin-top:7px"><br>
						<small class="w-100"> *) file type: jpg/jpeg/png | max size : 1 MB</small>
                            </div>
                        ...
                        <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ayah" alt="" width="200px"
                    style="margin-top:7px"><br>
						<small class="w-100"> *) file type: jpg/jpeg/png | max size : 1 MB</small>
                            </div>
                        ...
                        <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_surat_nikah" alt="" width="200px"
                    style="margin-top:7px"><br>
						<small class="w-100"> *) file type: jpg/jpeg/png | max size : 1 MB</small>
                            </div>
                        ...
                        <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_sk_kelahiran" alt="" width="200px"
                    style="margin-top:7px"><br>
						<small class="w-100"> *) file type: jpg/jpeg/png | max size : 1 MB</small>
                            </div>
                        ...
                        <div class="form-group row">
							...
							<div class="col-sm-8 pl-2">
                            <input type="text" name="no_kk" id="no_kk" class="form-control" value="{{old('no_kk')}}"/>
                            @if($errors->has('no_kk'))
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" name="nama_kepala_keluarga" id="nama_kepala_keluarga"
                                class="form-control" value="{{old('nama_kepala_keluarga')}}"/>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_bayi" id="nama_bayi" class="form-control" value="{{old('nama_bayi')}}" />
                                ...
                                <div class="form-check-inline">
                                    <label class="form-check-label" for="laki-laki">
                                        <input type="radio" class="form-check-input" id="laki-laki" name="jk_bayi"
                                            value="laki-laki" {{(old('jk_bayi')=='laki-laki')?'checked':''}}>Laki-laki
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label" for="perempuan">
                                        <input type="radio" class="form-check-input" id="perempuan" name="jk_bayi"
                                            value="perempuan" {{(old('jk_bayi')=='perempuan')?'checked':''}}>Perempuan
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="tempat_dilahirkan" name="tempat_dilahirkan" class="form-control">
                                ...
                                <option value="rs/rb" {{(old('tempat_dilahirkan')=='rs/rb')?'selected':''}}>Rumah Sakit/Rumah Bersalin</option>
                        ...
                        <div class="form-group">
                            ...
                            <input id="tempat_lahir" name="tempat_lahir" type="text" class="form-control" value="{{old('tempat_lahir')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tgl_lahir_bayi" name="tgl_lahir_bayi" type="date" class="form-control" value="{{old('tgl_lahir_bayi')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="pukul" name="pukul" type="time" class="form-control" value="{{old('pukul')}}">
                            @if($errors->has('pukul'))
                        ...
                        <div class="form-group">
                            ...
                            <input id="kelahiran_ke" name="kelahiran_ke" type="text" class="form-control" value="{{old('kelahiran_ke')}}">
            ...
            <div class="list-group-item py-3" data-acc-step>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            <label for="">NIK</label>
                            <input id="nik_ibu" name="nik_ibu" type="text" class="form-control" value="{{old('nik_ibu')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nama_ibu" name="nama_ibu" type="text" class="form-control" value="{{old('nama_ibu')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tgl_lahir_ibu" name="tgl_lahir_ibu" type="date" class="form-control" value="{{old('tgl_lahir_ibu')}}">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <input id="umur_ibu" name="umur_ibu" type="text" class="form-control" value="{{old('umur_ibu')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="pekerjaan_id_ibu" name="pekerjaan_id_ibu" class="form-control">
                                ...
                                <option value="{{$data->id}}" {{(old('pekerjaan_id_ibu')==$data->id)?'selected':''}}>{{$data->nama}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="alamat_ibu" name="alamat_ibu" type="text"
                                class="form-control">{{old('alamat_ibu')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="provinsi_id_ibu" name="provinsi_id_ibu" class="form-control provinsi_ibu">
                                    <option value="">-- Pilih Salah Satu --</option>
                        ...
                        <div class="form-group">
                            <label for="" class="">Kota/Kabupaten</label>
                            <div class="">
                                <select id="kota_ibu" name="kota_id_ibu" class="form-control kota_ibu">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="kecamatan_ibu" name="kecamatan_id_ibu" class="form-control kecamatan_ibu">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="" class="">Desa/Kelurahan</label>
                            <div class="">
                                <select id="desa_ibu" name="area_id_ibu" class="form-control desa_ibu">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <input id="kebangsaan_ibu" name="kebangsaan_ibu" type="text" class="form-control" value="{{old('kebangsaan_ibu')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tgl_pencatatan_perkawinan" name="tgl_pencatatan_perkawinan" type="date"
                                class="form-control" value="{{old('tgl_pencatatan_perkawinan')}}">
            ...
            <div class="list-group-item py-3" data-acc-step>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            <label for="">NIK</label>
                            <input id="nik_ayah" name="nik_ayah" type="text" class="form-control" value="{{old('nik_ayah')}}">
                        ...
                        <div class="form-group">
                            <label for="">Nama Lengkap</label>
                            <input id="nama_ayah" name="nama_ayah" type="text" class="form-control" value="{{old('nama_ayah')}}">
                        ...
                        <div class="form-group">
                            <label for="">Tanggal Lahir</label>
                            <input id="tgl_lahir_ayah" name="tgl_lahir_ayah" type="date" class="form-control" value="{{old('tgl_lahir_ayah')}}">
                        ...
                        <!-- <div class="form-group">
                            <label for="">Umur</label>
                            <input id="umur_ayah" name="umur_ayah" type="text" class="form-control" value="{{old('umur_ayah')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="pekerjaan_id_ayah" name="pekerjaan_id_ayah" class="form-control">
                                <option value="">-- Pilih Salah Satu --</option>
                                @foreach($pekerjaan as $data)
                                <option value="{{$data->id}}"  {{(old('pekerjaan_id_ayah')==$data->id)?'selected':''}}>{{$data->nama}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="alamat_ayah" name="alamat_ayah" type="text"
                                class="form-control">{{old('alamat_ayah')}}</textarea>
                        ...
                        <div class="form-group">
                            <label for="" class="">Provinsi</label>
                            <div class="">
                                <select id="provinsi_id_ayah" name="provinsi_id_ayah" class="form-control provinsi_ayah">
                                    <option value="">-- Pilih Salah Satu --</option>
                                    @foreach($provinsi as $prov)
                                    <option value="{{$prov->id}}">{{$prov->nama}}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            <label for="" class="">Kota/Kabupaten</label>
                            <div class="">
                                <select id="kota_ayah" name="kota_id_ayah" class="form-control kota_ayah">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="" class="">Kecamatan</label>
                            <div class="">
                                <select id="kecamatan_ayah" name="kecamatan_id_ayah" class="form-control kecamatan_ayah">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="" class="">Desa/Kelurahan</label>
                            <div class="">
                                <select id="desa_ayah" name="area_id_ayah" class="form-control desa_ayah" >
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                                ...
                                <div class="form-check-inline">
                                    <label class="form-check-label" for="wni">
                                        <input type="radio" class="form-check-input" id="wni"
                                            name="kewarganegaraan_ayah" value="wni" {{(old('kewarganegaraan_ayah')=='wni')?'checked':''}}>WNI
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label" for="wna">
                                        <input type="radio" class="form-check-input" id="wna"
                                            name="kewarganegaraan_ayah" value="wna" {{(old('kewarganegaraan_ayah')=='wna')?'checked':''}}>WNA
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="kebangsaan_ayah" name="kebangsaan_ayah" type="text"
                                class="form-control" value="{{old('kebangsaan_ayah')}}">
            ...
            <div class="list-group-item py-3" data-acc-step>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            <label for="">NIK</label>
                            <input id="nik_pelapor" name="nik_pelapor" type="text" class="form-control" value="{{old('nik_pelapor')}}">
                        ...
                        <div class="form-group">
                            <label for="">Nama Lengkap</label>
                            <input id="nama_pelapor" name="nama_pelapor" type="text" class="form-control" value="{{old('nama_pelapor')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tgl_lahir_pelapor" name="tgl_lahir_pelapor" type="date"
                                class="form-control" value="{{old('tgl_lahir_pelapor')}}">
                        ...
                        <div class="form-group">
                            <label for="">Umur</label>
                            <input id="umur_pelapor" name="umur_pelapor" type="text" class="form-control" value="{{old('umur_pelapor')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="pekerjaan_id_pelapor" name="pekerjaan_id_pelapor"
                                ...
                                <option value="">-- Pilih Salah Satu --</option>
                                @foreach($pekerjaan as $data)
                                <option value="{{$data->id}}"  {{(old('pekerjaan_id_pelapor')==$data->id)?'selected':''}}>{{$data->nama}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="alamat_pelapor" name="alamat_pelapor" type="text"
                                class="form-control">{{old('alamat_pelapor')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="provinsi_id_pelapor" name="provinsi_id_pelapor"
                                    class="form-control provinsi_pelapor">
                                    <option value="">-- Pilih Salah Satu --</option>
                                    @foreach($provinsi as $prov)
                                    <option value="{{$prov->id}}">{{$prov->nama}}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            <label for="" class="">Kota/Kabupaten</label>
                            <div class="">
                                <select id="kota_pelapor" name="kota_id_pelapor" class="form-control kota_pelapor">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="kecamatan_pelapor" name="kecamatan_id_pelapor"
                                    class="form-control kecamatan_pelapor">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="" class="">Desa/Kelurahan</label>
                            <div class="">
                                <select id="desa_pelapor" name="area_id_pelapor" class="form-control desa_pelapor">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nik_saksi1" name="nik_saksi1" type="text" class="form-control" value="{{old('nik_saksi1')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nama_saksi1" name="nama_saksi1" type="text" class="form-control" value="{{old('nama_saksi1')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="umur_saksi1" name="umur_saksi1" type="text" class="form-control" value="{{old('umur_saksi1')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="jk_saksi1" name="jk_saksi1"
                                    class="form-control">
                                    <option value="laki-laki"  {{(old('jk_saksi1')=='laki-laki')?'selected':''}}>Laki-laki</option>
                                    <option value="perempuan"  {{(old('jk_saksi1')=='perempuan')?'selected':''}}>Perempuan</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="">Pekerjaan</label>
                            <select id="pekerjaan_id_saksi1" name="pekerjaan_id_saksi1" class="form-control">
                                <option value="">-- Pilih Salah Satu --</option>
                                @foreach($pekerjaan as $data)
                                <option value="{{$data->id}}"  {{(old('pekerjaan_id_saksi1')==$data->id)?'selected':''}}>{{$data->nama}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="alamat_saksi1" name="alamat_saksi1" type="text"
                                class="form-control">{{old('alamat_saksi1')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="provinsi_id_saksi1" name="provinsi_id_saksi1"
                                    class="form-control provinsi_saksi1">
                                    <option value="">-- Pilih Salah Satu --</option>
                                    @foreach($provinsi as $prov)
                                    <option value="{{$prov->id}}">{{$prov->nama}}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            <label for="" class="">Kota/Kabupaten</label>
                            <div class="">
                                <select id="kota_saksi1" name="kota_id_saksi1" class="form-control kota_saksi1">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="kecamatan_saksi1" name="kecamatan_id_saksi1"
                                    class="form-control kecamatan_saksi1">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="" class="">Desa/Kelurahan</label>
                            <div class="">
                                <select id="desa_saksi1" name="area_id_saksi1" class="form-control desa_saksi1">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nik_saksi2" name="nik_saksi2" type="text" class="form-control" value="{{old('nik_saksi2')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nama_saksi2" name="nama_saksi2" type="text" class="form-control" value="{{old('nama_saksi2')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="umur_saksi2" name="umur_saksi2" type="text" class="form-control" value="{{old('umur_saksi2')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="jk_saksi2" name="jk_saksi2"
                                    class="form-control">
                                    <option value="laki-laki"  {{(old('jk_saksi2')=='laki-laki')?'selected':''}}>Laki-laki</option>
                                    <option value="perempuan"  {{(old('jk_saksi2')=='perempuan')?'selected':''}}>Perempuan</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="">Pekerjaan</label>
                            <select id="pekerjaan_id_saksi2" name="pekerjaan_id_saksi2" class="form-control">
                                <option value="">-- Pilih Salah Satu --</option>
                                @foreach($pekerjaan as $data)
                                <option value="{{$data->id}}"  {{(old('pekerjaan_id_saksi2')==$data->id)?'selected':''}}>{{$data->nama}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="alamat_saksi2" name="alamat_saksi2" type="text"
                                class="form-control">{{old('alamat_saksi2')}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="provinsi_saksi2" name="provinsi_id_saksi2"
                                    class="form-control provinsi_saksi2">
                                    <option value="">-- Pilih Salah Satu --</option>
                                    @foreach($provinsi as $prov)
                                    <option value="{{$prov->id}}">{{$prov->nama}}</option>
                                    @endforeach
                        ...
                        <div class="form-group">
                            <label for="" class="">Kota/Kabupaten</label>
                            <div class="">
                                <select id="kota_saksi2" name="kota_id_saksi2" class="form-control kota_saksi2">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select id="kecamatan_saksi2" name="kecamatan_id_saksi2"
                                    class="form-control kecamatan_saksi2">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="" class="">Desa/Kelurahan</label>
                            <div class="">
                                <select id="desa_saksi2" name="area_id_saksi2" class="form-control desa_saksi2">
                                    <option value="">-- Pilih Salah Satu --</option>
                                </select>
