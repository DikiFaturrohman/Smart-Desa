    ...
    <form method="post" enctype="multipart/form-data" id="mainform">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <div class="custom-file">
                    <input type="hidden" name="suket_id" value="{{$sksj->id}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" value="{{old('nik',$sksj->no_nik)}}" readonly>
                @if($errors->has('nik'))
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap"
                    value="{{old('nama',$sksj->nama_penduduk)}}" readonly>
                @if($errors->has('nama'))
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="number" min="1" class="form-control" name="umur" placeholder="" value="{{old('umur',$sksj->umur)}}" readonly>
                @if($errors->has('umur'))
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="date" class="form-control" id="tgl_menetap"
                    name="tgl_menetap"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                <select id="pekerjaan_id" name="pekerjaan_id" class="auto-save form-control">
                    ...
                    <option value="{{$data->id}}" {{(old('pekerjaan_id',$sksj->pekerjaan_id)==$data->id)?'selected':''}}>{{$data->nama}}
                    </option>
                    @endforeach
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <textarea class="form-control" rows="3" id="alamat" name="alamat"
                    placeholder="Masukkan alamat lengkap beserta RT/RW nya" readonly>{{old('alamat',$sksj->alamat_kantor)}}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="text" class="form-control" name="keperluan" placeholder="" value="{{old('keperluan',$sksj->keperluan)}}">
