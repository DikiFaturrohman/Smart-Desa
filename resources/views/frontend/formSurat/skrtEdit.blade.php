                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 pl-2">
                                <div class="custom-file">
                                    <input type="hidden" name="suket_id" value="{{$skrt->id}}">
                                ...
                                <img src="<?php echo (!empty($skrt->file_surat_tanah) ? $img . '/dokumen/skrt/surat_tanah/' . $skrt->file_surat_tanah : $img . '/default.jpg') ?>"
                                    id="preview-file_surat_tanah" style="width: 200px;margin-top:7px"><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 pl-2">
                                ...
                                <img src="<?php echo (!empty($skrt->file_surat_pajak_tanah) ? $img . '/dokumen/skrt/surat_pajak_tanah/' . $skrt->file_surat_pajak_tanah : $img . '/default.jpg') ?>"
                                    id="preview-file_surat_pajak_tanah" style="width: 200px;margin-top:7px"><br>
                                <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nik_pemilik" id="nik" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_pemilik" id="nama" class="form-control"
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_riwayat1"  class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="atas_nama1" id="nama" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_riwayat2"  class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="atas_nama2" id="nama" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="berdasarkan2" class="form-control">

                                <option value="jual beli"
                                    {{(old('berdasarkan2',$skrt->berdasarkan2)=='jual beli')?'selected':''}}>Jual Beli
                                </option>

                                <option value="hibah"
                                    {{(old('berdasarkan2',$skrt->berdasarkan2)=='hibah')?'selected':''}}>Hibah</option>

                                <option value="waris"
                                    {{(old('berdasarkan2',$skrt->berdasarkan2)=='waris')?'selected':''}}>Waris</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_riwayat3"  class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="atas_nama3" id="nama" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="berdasarkan3" class="form-control">

                                <option value="jual beli"
                                    {{(old('berdasarkan3',$skrt->berdasarkan3)=='jual beli')?'selected':''}}>Jual Beli
                                </option>

                                <option value="hibah"
                                    {{(old('berdasarkan3',$skrt->berdasarkan3)=='jual beli')?'selected':''}}>Hibah
                                </option>

                                <option value="waris"
                                    {{(old('berdasarkan3',$skrt->berdasarkan3)=='jual beli')?'selected':''}}>Waris
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_riwayat4"  class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="atas_nama4" id="nama" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select id="" name="berdasarkan4" class="form-control">

                                <option value="jual beli"
                                    {{(old('berdasarkan4',$skrt->berdasarkan4)=='jual beli')?'selected':''}}>Jual Beli
                                </option>

                                <option value="hibah"
                                    {{(old('berdasarkan4',$skrt->berdasarkan4)=='hibah')?'selected':''}}>Hibah</option>

                                <option value="waris"
                                    {{(old('berdasarkan4',$skrt->berdasarkan4)=='waris')?'selected':''}}>Waris</option>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_sertifikat" id="sppt" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_sppt" id="sppt" class="form-control"
                                value="{{old('no_sppt',$skrt->no_sppt)}}" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="persil" id="persil" class="form-control"
                                value="{{old('persil',$skrt->persil)}}" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_kihir" id="kokigi" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="luas" id="sppt" class="form-control"
                                placeholder="ukuran dalam skala m&sup2;" value="{{old('luas',$skrt->luas)}}" />
                            @if($errors->has('luas'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alamat" class="form-control">{{old('alamat',$skrt->alamat)}}</textarea>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sebelah_utara" id="batasutara" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sebelah_timur" id="batastimur" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sebelah_selatan" id="batasselatan" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sebelah_barat" id="batasbarat" class="form-control"
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nik_saksi1" id="nik_saksi1" class="form-control"
                                value="{{old('nik_saksi1',$skrt->nik_saksi1)}}" />
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nik_saksi2" id="nik_saksi2" class="form-control"
                                value="{{old('nik_saksi2',$skrt->nik_saksi2)}}" />
