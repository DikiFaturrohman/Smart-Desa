    ...
    <form method="post" enctype="multipart/form-data" id="mainform">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="number" min="1" class="form-control" name="umur" placeholder="" value="{{old('umur',\Carbon\Carbon::now()->diffInYears(Auth::guard('masyarakat')->user()->tgl_lahir))}}" readonly>
                @if($errors->has('umur'))
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <input type="date" class="form-control"
                    name="tgl_menetap" value="{{old('tgl_menetap')}}" />
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 pl-2">
                ...
                <textarea class="form-control" rows="3" id="alamat" name="alamat"
                    placeholder="Masukkan alamat lengkap beserta RT/RW nya" readonly>{{old('alamat',Auth::guard('masyarakat')->user()->alamat,Auth::guard('masyarakat')->user()->alamat)}}</textarea>
