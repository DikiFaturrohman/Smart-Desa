                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 pl-2">
                                ...
                                <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ktp_alm" alt="" width="200px"
                    style="margin-top:7px"><br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 pl-2">
                                ...
                                <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ktp_pelapor" alt="" width="200px"
                    style="margin-top:7px"><br>
                                <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 pl-2">
                                ...
                                <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_ktp_saksi" alt="" width="200px"
                    style="margin-top:7px"><br>
                                <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 pl-2">
                                ...
                                <img src="{{asset('backend/images/default.jpg')}}" id="preview-file_sk_rs" alt="" width="200px"
                    style="margin-top:7px"><br>
                                <small class="w-100"> *) file type: jpg/jpeg/png | max size: 1 MB</small>
                            </div>
                        </div>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="tgl_lahir_jenazah" name="tgl_lahir_jenazah" type="date"
                                class="form-control" value="{{old('tgl_lahir_jenazah')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="pekerjaan_id_jenazah" name="pekerjaan_id_jenazah"
                                ...
                                <option value="{{$data->id}}" {{(old('pekerjaan_id_jenazah')==$data->id)?'selected':''}}>{{$data->nama}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="alamat_jenazah" name="alamat_jenazah" type="text"
                                class="form-control">{{old('alamat_jenazah')}}</textarea>
                            ...
                            <div class="checkbox">
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input " type="radio" id="gridRadios1" name="kewarganegaraan"
                                        value="wni" {{(old('kewarganegaraan')=='wni')?'checked':''}}>
                                ...
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="radio" id="gridRadios2" name="kewarganegaraan"
                                        value="wna" {{(old('kewarganegaraan')=='wna')?'checked':''}}>
                        ...
                        <div class="form-group">
                            ...
                            <select id="keturunan" name="keturunan" class="form-control">
                                ...
                                <option value="cina/timur asing lainnya" {{(old('keturunan')=='cina/timur asing lainnya')?'selected':''}}>Cina/timur asing lainnya</option>
                                <option value="indonesia" {{(old('keturunan')=='indonesia')?'selected':''}}>Indonesia</option>
                                <option value="indonesia nasrani" {{(old('keturunan')=='indonesia nasrani')?'selected':''}}>Indonesia Nasrani</option>
                        ...
                        <div class="form-group">
                            ...
                            <input id="" name="kebangsaan" type="text" class="form-control"  value="{{old('kebangsaan')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="" name="anak_ke" type="text" class="form-control" value="{{old('anak_ke')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="" name="tgl_kematian" type="date" class="form-control" value="{{old('tgl_kematian')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="" name="pukul" type="time" class="form-control" value="{{old('pukul')}}">
                            @if($errors->has('pukul'))
                        ...
                        <div class="form-group">
                            ...
                            <input id="" name="tempat_kematian" type="text" class="form-control" value="{{old('tempat_kematian')}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="yang_menerangkan" name="yang_menerangkan" class="form-control">
                                <option value="dokter" {{(old('yang_menerangkan')=='dokter')?'selected':''}}>Dokter</option>
                                <option value="tenaga kesehatan" {{(old('yang_menerangkan')=='tenaga kesehatan')?'selected':''}}>Tenaga Kesehatan</option>
                                <option value="kepolisian" {{(old('yang_menerangkan')=='kepolisian')?'selected':''}}>Kepolisian</option>
                                <option value="lainnya" {{(old('yang_menerangkan')=='lainnya')?'selected':''}}>Lainnya</option>
                            </select>
                ...
                <div data-acc-content>
                    ...
                    <div class="my-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nik_pelapor" class="form-control" value="{{old('nik_pelapor')}}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="umur_pelapor" class="form-control" value="{{old('umur_pelapor')}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" name="alamat_pelapor" id="alamat_pelapor">{{old('alamat_pelapor')}}</textarea>
            ...
            <div data-acc-content>
                ...
                <div class="my-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nik_saksi1" id="nik_saksi1" class="form-control" value="{{old('nik_saksi1')}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_saksi1" id="nama_saksi1" class="form-control" value="{{old('nama_saksi1')}}"/>
            ...
            <div data-acc-content>
                ...
                <div class="my-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nik_saksi2" id="nik_saksi2" class="form-control" value="{{old('nik_saksi2')}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_saksi2" id="nama_saksi2" class="form-control" value="{{old('nama_saksi2')}}"/>
