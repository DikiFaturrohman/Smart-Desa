...
@section('title') Agenda Desa @endsection
...
<div class="row py-2 my-2">
    ...
    <div class="col-lg-8 col-md-6">
            ...
            <div class="card mb-1">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="container">
                                ...
                                <small class="text-white">
                                    ...
                                    <i
                                        class="fa fa-calendar-alt"></i>&nbsp;{{\Carbon\Carbon::parse($row->created_at)->translatedFormat('d F Y')}}&nbsp;|&nbsp;
                                ...
                                <div class="tablistjudul">
                                    ...
                                    <h5 class="judulagenda">
                                        ...
                                        <a data-toggle="collapse" href="#collapse-{{$i}}" aria-expanded="true"
                                            aria-controls="collapse-{{$i}}" id="heading-{{$i}}" class="d-block">
                ...
                <div id="collapse-{{$i}}" class="collapse" aria-labelledby="heading-{{$i}}">
                    ...
                    <div class="card-body">
                        ...
                        <i
                            class="fa fa-clock"></i>&nbsp;{{\Carbon\Carbon::parse($row->start_date)->translatedFormat('h.i')}}
                        - {{\Carbon\Carbon::parse($row->end_date)->translatedFormat('h.i')}} WIB

                        <br><i class="fa fa-calendar-alt"></i>&nbsp;

                        {{\Carbon\Carbon::parse($row->start_date)->translatedFormat('d F Y')}} -
                        {{\Carbon\Carbon::parse($row->end_date)->translatedFormat('d F Y')}}
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{route('frontend.agenda.detail',['slug'=>$row->slug])}}"
        ...
        <div class="pt-3">
            ...
            {{$agendas->links('frontend.layout.pagination')}}
