...
@section('title') Kondisi Geografis Desa @endsection
...
<section class="py-4">
	<div class="container">
		...
		<div class="row">
				<div class="container">
					<img src="{{asset('backend/images/profil/desa/'.$data->foto_desa)}}" class="img-fluid rounded" alt="">
						<div class="py-3">
							{!! $data->kondisi_geografis !!}
						</div>
				</div>
		</div>
		@endforeach
