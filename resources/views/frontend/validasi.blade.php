...
@section('title') Validasi Dokumen @endsection
...
<div class="container py-3">
    ...
    <div class="alert alert-success"> Dokumen Tervalidasi</div>
    <div class="table-responsive py-2">
        <div class="container">
            <table id="download" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th width="29%">Ditandatangani oleh</th>
                        <th width="2%">:</th>
                        <th width="69%">{!! $signer->signer_name !!}</th>
                    </tr>
                    <tr>
                        <th width="29%">Lokasi</th>
                        <th width="2%">:</th>
                        <th width="69%">{{$dokumen->location}}</th>
                    </tr>
                    <tr>
                        <th width="29%">Alasan</th>
                        <th width="2%">:</th>
                        <th width="69%">{{$dokumen->reason}}</th>
                    </tr>
                    <tr>
                        <th width="29%">Ditandatangani Pada</th>
                        <th width="2%">:</th>
                        <th width="69%">{{\Carbon\Carbon::parse($dokumen->signed_in)->translatedFormat('d F Y H:i')}}
                        </th>
                    </tr>
                    <tr>
                        <th width="29%">Penerbit</th>
                        <th width="2%">:</th>
                        <th width="69%">{{$signer->issuer_dn}}</th>
                    </tr>
                    <tr>
                        <th width="29%" style="vertical-align: top;">Dokumen Preview</th>
                        <th width="2%" style="vertical-align: top;">:</th>
                        <th width="69%" style="vertical-align: bottom;"><iframe src="{{$url}}" frameborder="0"
                                width="100%" height="500px"></iframe></th>
                    </tr>
                </thead>
            </table>
        </div>
    ...
    @else
    <div class="alert alert-danger"> Dokumen Belum Tervalidasi</div>
    @endif
    <div class="line"></div>
