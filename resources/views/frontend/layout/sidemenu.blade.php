<nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        ...
        <p class="f1-l-1"><u>{{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}} {{ucwords(strtolower($lokasi->nama))}}</u></p>
        ...
        <li class="{{ Request::routeIs('frontend.profil.*') ? 'active' : '' }}">
            ...
            <a href="#profil" data-toggle="collapse" aria-expanded="false">Profil {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
            ...
            <ul class="collapse list-unstyled" id="profil">
                ...
                <li>
                    ...
                    <a href="{{route('frontend.profil.sejarah')}}">Sejarah {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
                ...
                <li>
                    ...
                    <a href="{{route('frontend.profil.gambaranumum')}}">Gambaran Umum {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
...
<li class="{{ Request::routeIs('frontend.potensi.*') ? 'active' : '' }}">
            ...
            <a href="#potensi" data-toggle="collapse" aria-expanded="false">Potensi {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
        ...
        <li class="{{ Request::routeIs('frontend.program.*') ? 'active' : '' }}">
            ...
            <a href="#program" data-toggle="collapse" aria-expanded="false">Program {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
        ...
        <li class="{{ Request::routeIs('frontend.pemdes.*') ? 'active' : '' }}">
            ...
            <a href="#pemdes" data-toggle="collapse" aria-expanded="false">Pemerintah {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
            ...
            <ul class="collapse list-unstyled" id="pemdes">
                ...
                <li>
                    ...
                    <a href="{{route('frontend.pemdes.kades')}}">Kepala {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
                ...
                <li>
                    ...
                    <a href="{{route('frontend.pemdes.perangkat')}}">Perangkat {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
                ...
                <li>
                    ...
                    <a href="{{route('frontend.pemdes.kantor')}}">Kantor {{(Session::get('kecamatan_id') == '2018110602402')?'Kelurahan':'Desa'}}</a>
	...
	<li class="{{ Request::routeIs('frontend.changePassword*') ? 'active' : '' }}">
        ...
        <!-- <li>
            ...
            <a href="#kerjasama" data-toggle="collapse" aria-expanded="false">Kerjasama</a>



            <ul class="collapse list-unstyled" id="kerjasama">
