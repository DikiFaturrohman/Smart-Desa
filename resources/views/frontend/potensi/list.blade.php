			...
			<div class="sidelist shadow">
				...
				<div class="row">
					...
					<div class="col-md-4 img-container">
							...
							<img class="img-side-fit" width="100%" src="{{($row->img)?asset('backend/images/potensi/'.$row->img):asset('backend/images/default.jpg')}}" alt="{{($row->name)}}"/>
					...
					<div class="col-md-7 px-2 py-2">
						...
						<small class="f1-s-3">
							...
							<i class="fa fa-calendar-alt"></i>&nbsp;{{\Carbon\Carbon::parse($row->created_at)->translatedFormat('l, d F Y')}}&nbsp;|&nbsp;
						...
						<h5 class="pt-1">
							...
							<a href="{{route('frontend.potensi.detail',['slug'=>$row->slug])}}" class="">
						...
						<p class="text-justify f1-s-5">
							...
							{{$row->short_description}}<a href="{{route('frontend.potensi.detail',['slug'=>$row->slug])}}" class="badge badge-secondary">Selengkapnya....</a>
				...
				<div class="card-header">
					...
					<ul class="nav nav-tabs card-header-tabs" id="side-list" role="tablist">
						...
						<li class="nav-item">
							...
							<a class="nav-link active" href="#pengumuman" role="tab" aria-controls="pengumuman" aria-selected="true">Pengumuman</a>

						</li>

						<li class="nav-item">

							<a class="nav-link"  href="#agenda" role="tab" aria-controls="agenda" aria-selected="false">Agenda</a>
				...
				<div class="card-header">
					...
					<ul class="nav nav-tabs card-header-tabs" id="side-list2" role="tablist">
						...
						<li class="nav-item">
							...
							<a class="nav-link active" href="#berita" role="tab" aria-controls="berita" aria-selected="true">Berita</a>
