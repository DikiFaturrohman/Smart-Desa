            ...
            <div class="card" style="margin-bottom:110px" id="login-desktop">
              ...
              <div class="card-body">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="NIK" name="nik" value="{{old('nik')}}" autocomplete="false">
                    </div>
                    @if($errors->has('nik'))
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input id="pass_log_id" type="password" class="form-control" placeholder="Password" name="password" autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly');">
              ...
              <div class="card-footer">
                <div class="d-flex justify-content-center">
                  <strong><a class="text-white" href="{{route('frontend.password.forgot')}}">Lupa Kata Sandi?</a></strong>
                </div>
              </div>
            </div>                    	
                ...
                <div class="card-body">
                  <form action="" method="post" autocomplete="off">
                      ...
                      <div class="input-group mb-3">
                          ...
                          <input id="pass_log_id" type="password" class="form-control" placeholder="Password" name="password" autocomplete="new-password">
                          <div class="input-group-append mata">
                              <span class="input-group-text"><i toggle="#password-field" class="fa fa-eye-slash toggle-password"></i></span>
                          </div>
                      </div>
                  ...
                  <div class="row">
                	<div class="col-lg-6 col-sm-6">
                  	...
                  	<div class="col-lg-6 col-sm-6">
                    	<img id="content-desktop" src="{{asset('public/frontend/img/support.png')}}" class="img-fluid" style="display:block;height:80px;width:auto;">
					</div>					
			      </div>
                </div>
                <div class="card-footer" style="padding:0">
                  <div class="d-flex justify-content-center">
                    <strong><a class="text-white" href="{{route('frontend.forgotPassword')}}">Lupa Kata Sandi?</a></strong>
...
<div class="container py-3 my-2 pb-4 mb-2" id="login-mobile">
              <form action="" method="post" autocomplete="off">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" min="0" class="form-control" placeholder="Masukan NIK KTP" name="nik" value="{{old('nik')}}">
                </div>  
                @if($errors->has('nik'))
                    <small class="text-danger">{{$errors->first('nik')}}</small>
                @endif
              ...
              <div class="row">
				<div class="col-lg-6 col-sm-6">
					<img id="content-desktop" src="{{asset('public/backend/images/logo-bsre.png')}}" class="img-fluid" style="display:block;height:70px;width:150px;">
				</div>
			  </div>
                <div class="">
                  Tidak punya akun?<a href="{{route('frontend.register')}}"><strong>Daftar disini</strong></a><br>
                  atau <strong><a class="" href="{{route('frontend.forgotPassword')}}">klik disini</a></strong> jika lupa kata sandi
                </div>
</div>
@endif
@endsection
