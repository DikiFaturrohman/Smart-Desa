...
@section('title') Kepala Desa @endsection
						...
						<div class="py-2 my-2">
							<div class="row">
								<div class="col-md-4 pr-4">
									<img class="img-fluid rounded" src="{{($profil->foto_kades)?asset('backend/images/profil/kades/'.$profil->foto_kades):asset('backend/images/avatar/avatar-1.png')}}" alt="{{$profil->kades}}">
								</div>
								<div class="col-md-8">
									<h2>{{$profil->kades}}</h2>
									<hr>
