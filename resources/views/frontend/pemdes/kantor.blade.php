...
@section('title') Kantor Desa @endsection
...
<section class="py-4">
	<div class="container">
		<div class="row">
				<div class="container">
					<h2 class="subjudul-home"><span class="span-judul"><a href="#">Kantor Desa</a></span></h2>
				</div>
		</div>
		<div class="row">
				<div class="container">
						<div class="py-2 my-2">
							<div class="row">
				              ...
				              <tr>
				                ...
				                <td valign="top">&nbsp;</td>
				                <td valign="top">Desa {{$profil->nama}}</td>
				              </tr>
				              <tr>
				                <td valign="top"><i class="fa fa-phone"></i></td>
				                <td valign="top">&nbsp;</td>
				                <td valign="top">{{$profil->no_telpon}}</td>
				              </tr>
				              <tr>
				                <td valign="top"><i class="fa fa-envelope"></i></td>
				                <td valign="top">&nbsp;</td>
				                <td valign="top">{{$profil->email}}</td>
				              </tr>
											<tr>
				                <td valign="top"><i class="fa fa-map-marker-alt"></i></td>
				                <td valign="top">&nbsp;</td>
				                <td valign="top">{{ strip_tags($profil->alamat) }}</td>
				              </tr>
				          </table>
									<hr>
									<h3>
										<br>Latitude : {{$profil->latitude}}
										<br>Longitude : {{$profil->longitude}}
									</h3>
								</div>
								<div class="col-md-6">
									<img class="img-fluid rounded" src="{{($profil->foto_desa)?asset('backend/images/profil/desa/'.$profil->foto_desa):asset('backend/images/default.jpg')}}" alt="{{$profil->nama}}">
								</div>
							</div>
						</div>
				</div>
