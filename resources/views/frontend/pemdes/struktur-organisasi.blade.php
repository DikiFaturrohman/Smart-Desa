...
@section('title') Struktur Organisasi Desa @endsection
...
<section class="py-4">
	<div class="container">
		<div class="row">
				<div class="container">
					<h2 class="subjudul-home"><span class="span-judul"><a href="#">Struktur Organisasi Desa</a></span></h2>
				</div>
		</div>
		<div class="row">
				<div class="container">
						<div class="py-2 my-2">
							...
							@else
							<center>
								<h3 class="pb-4">{{$organisasi->title}}</h3>
								<img class="img-fluid" src="{{($organisasi->img)?asset('backend/images/struktur-organisasi/'.$organisasi->img):asset('backend/images/default.jpg')}}" alt="{{$organisasi->title}}">
							</center>
							@endif
						</div>
				</div>
