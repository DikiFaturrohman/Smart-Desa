...
@section('title') Info Grafis Desa @endsection
...
<div class="row py-2 my-2">
	...
	<div class="col-lg-8 col-md-6">
			...
			<div class="sidelist shadow">
				...
				<div class="row">
					...
					<div class="col-md-4 img-container">
							...
							<img class="img-side-fit" width="100%" src="{{($row->img)?asset('backend/images/informasi/infoGrafis/'.$row->img):asset('backend/images/default.jpg')}}" alt="{{($row->title)}}"/>						
					...
					<div class="col-md-7 px-2 py-2">
						...
						<h5 class="pt-1">
							...
							<a href="{{route('frontend.infografis.detail',['slug'=>$row->slug])}}" class="">
						...
						<p class="text-justify f1-s-5">
							...
							{{$row->short_content}}&nbsp;<a href="{{route('frontend.infografis.detail',['slug'=>$row->slug])}}" class="badge badge-secondary"> more....</a>
		...
		<div class="pt-3">
			...
			@if(!empty($grafis))
				{{$grafis->links('frontend.layout.pagination')}}
