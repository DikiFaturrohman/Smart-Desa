...
<meta property="og:image"
    content="{{($video->img)?asset('backend/images/informasi/video/'.$video->img):asset('backend/images/default.jpg')}}" />
@endsection
 ...
 -->
                ...
                <div class="flex-wr-s-s p-b-10">
                    <span class="f1-s-3 m-r-15">
                        <span>
                            <i class="fa fa-user"></i> {{$video->created_by}} |&nbsp;
                        </span>
                        <span>
                        ...
                        <span>
                            <i class="fa fa-eye"></i> {{$video->hit}} Dilihat |&nbsp;
                        </span>
                        <span>
            ...
            <div class="detail-content pb-4">
                ...
                <center>
                    <iframe frameBorder="0" src="{{str_replace('watch?v=','embed/',$video->url)}}" width="100%"
                        height="500px"></iframe>
                </center>
            </div>
            ...
            <div class="pb-2 mb-2">
                ...
                <form method="post" action="{{route('frontend.komentar')}}">
                    @csrf
                    <div class="row pb-2">
                        <input type="hidden" name="info_id" value="{{$video->id}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 pl-3 pr-1">
                                <p class="d-flex justify-content-between">
                                    <a class="pt-0 mt-0" href="#"><strong>{{$data->nama}}</strong></a>
                                    <span class="f1-s-3"><i
                        ...
                        <div class="tab-pane active" id="berita" role="tabpanel">
                            ...
                            <div class="sidelist shadow">
                                <div class="row">
                                    <div class="col-md-4 img-container">
                                        <img class="img-to-fit" width="100%"
                                            src="{{($tabberita)?asset('backend/images/informasi/berita/'.$tabberita->img):asset('backend/images/default.jpg')}}"
                                            alt="{{($tabberita->title)}}" />
                                    </div>
                                    <div class="col-md-7 px-2 py-2">
                                        <small class="f1-s-3">
