...
@section('title') {{$pengumumans->title}} @endsection

@section('meta')
<meta name="description" content="{{strip_tags($pengumumans->description)}}" />
<meta name="keywords" content="{{strip_tags($pengumumans->title)}}" />
<meta property="og:title" content="{{$pengumumans->title}} "/>
<meta property="og:type" content="agenda"/>   
<meta property="og:image" content="{{($pengumumans->img)?asset('backend/images/informasi/pengumuman/'.$pengumumans->img):asset('backend/images/default.jpg')}}"/>
@endsection
    ...
    <div class="col-lg-8 col-md-6">
        ...
        <div class="container pl-4">
            ...
            <div class="pb-4">
                ...
                <div class="p-b-10">
                    <span class="f1-s-3 m-r-15">
                        <span>
                            <i class="fa fa-user"></i> {{$pengumumans->created_by}} |&nbsp;
                        </span>
                        <span>
                            <i class="fa fa-calendar-alt"></i>
                            {{\Carbon\Carbon::parse($pengumumans->created_at)->translatedFormat('d F Y')}} |&nbsp;
                        </span>
                        <span>
                            <i class="fa fa-eye"></i> {{$pengumumans->hit}} Dilihat |&nbsp;
                        </span>
                        <span>
            ...
            <div class="detail-content pb-4">
                ...
                <img src="{{($pengumumans->img)?asset('backend/images/informasi/pengumuman/'.$pengumumans->img):asset('backend/images/default.jpg')}}"
                    alt="{{$pengumumans->title}}" class="img-fluid rounded">

            </div>

            <p class="f1-s-11 cl6 p-b-25">

                {!! $pengumumans->description !!}
            ...
            <div class="pb-2 mb-2">
                ...
                <form method="post" action="{{route('frontend.komentar')}}">
                    @csrf
                    <div class="row pb-2">
                        <input type="hidden" name="info_id" value="{{$pengumumans->id}}">
                        <input type="hidden" name="kategori" value="pengumuman">
                        <textarea rows="4"
