...
@section('title') {{$foto->title}} @endsection
 ...
 -->
                ...
                <div class="flex-wr-s-s p-b-10">
                    <span class="f1-s-3 m-r-15">
                        <span>
                            <i class="fa fa-user"></i> {{$foto->created_by}} |&nbsp;
                        </span>
                        <span>
                            <i class="fa fa-calendar-alt"></i>
                            {{\Carbon\Carbon::parse($foto->created_at)->translatedFormat('d F Y')}} |&nbsp;
                        </span>
                        <span>
                            <i class="fa fa-eye"></i> {{$foto->hit}} Dilihat |&nbsp;
                        </span>
                        <span>
            ...
            <div class="detail-content pb-4">
                ...
                <img src="{{($foto->img)?asset('backend/images/galeri/foto/'.$foto->img):asset('backend/images/default.jpg')}}" alt="{{$foto->title}}"
            ...
            <div class="pb-2 mb-2">
                ...
                <form method="post" action="{{route('frontend.komentar')}}">
                    @csrf
                    <div class="row pb-2">
                        <input type="hidden" name="info_id" value="{{$foto->id}}">
                        <input type="hidden" name="kategori" value="foto">
                        <textarea rows="4"
