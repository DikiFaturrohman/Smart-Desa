...
<div class="row py-2 my-2">
    ...
    <div class="col-lg-8 col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4 img-container">
                        <img class="img-to-fit" width="100%"
                            src="{{($row->img)?asset('backend/images/galeri/foto/'.$row->img):asset('backend/images/default.jpg')}}" alt="{{($row->title)}}" />
                    </div>
                    <div class="col-md-7 px-2 py-2">
                        ...
                        <h5 class="pt-1">
                            <a href="{{route('frontend.foto.detail',['slug'=>$row->slug])}}" class="">
                                {{$row->title}}
                            </a>
                        </h5>
        ...
        <div class="pt-3">
            ...
            <span></span>
            @else
            {{$foto->links('frontend.layout.pagination')}}
            @endif
        </div>
