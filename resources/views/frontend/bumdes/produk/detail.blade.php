...
@section('title') {{$bumdes->name}} @endsection
    ...
    <div class="col-lg-8 col-md-6">
        ...
        <div class="container pl-4">
            ...
            <div class="pb-4">
                ...
                <a href="{{route('frontend.bumdes.profil.detail',['slug'=>$bumdes->bumdes->slug])}}"
                    class="f1-s-10 cl2 hov-cl10 trans-03 text-uppercase">

                    <strong>{{$bumdes->bumdes->name}}</strong>
                </a>
                ...
                <div class="flex-wr-s-s p-b-10">
                    <span class="f1-s-3 m-r-15">
                        <span>
                            <i class="fa fa-user"></i> {{$bumdes->created_by}} |&nbsp;
                        </span>
                        <span>
                            <i class="fa fa-calendar-alt"></i>
                            {{\Carbon\Carbon::parse($bumdes->created_at)->translatedFormat('d F Y')}} |&nbsp;
                        </span>
                        <span>
                            <i class="fa fa-eye"></i> {{$bumdes->hit}} Dilihat |&nbsp;
                        </span>
                        <span>
                            <i class="fa fa-comment"></i> {{count($komentar)}} Komentar
                        </span>
                    </span>
                </div>
            ...
            <div class="detail-content pb-4">
                ...
                <img src="{{($bumdes->img)?asset('backend/images/bumdes/produk/'.$bumdes->img):asset('backend/images/default.jpg')}}" alt="{{$bumdes->name}}"
            ...
            <div class="pb-2 mb-2">
                ...
                <form method="post" action="{{route('frontend.komentar')}}">
                    @csrf
                    <div class="row pb-2">
                        <input type="hidden" name="info_id" value="{{$bumdes->id}}">
