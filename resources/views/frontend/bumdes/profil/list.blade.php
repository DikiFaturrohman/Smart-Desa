			...
			<div class="sidelist shadow">
				...
				<div class="row">
					...
					<div class="col-md-4 img-container">
							...
							<img class="img-side-fit" width="100%" src="{{($row->img)?asset('backend/images/bumdes/profil/'.$row->img):asset('backend/images/default.jpg')}}" alt="{{($row->name)}}"/>
					...
					<div class="col-md-7 px-2 py-2">
						...
						<h5 class="pt-1">
							...
							<a href="{{route('frontend.bumdes.profil.detail',['slug'=>$row->slug])}}" class="">
						...
						<p class="text-justify f1-s-5">
							...
							{{$row->short_description}}&nbsp;<a href="{{route('frontend.bumdes.profil.detail',['slug'=>$row->slug])}}" class="badge badge-secondary"> Selengkapnya....</a>
