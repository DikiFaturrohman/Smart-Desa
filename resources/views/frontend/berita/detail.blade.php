...
@section('title') {{$beritas->title}} @endsection

@section('meta')
<meta name="description" content="{{strip_tags($beritas->content)}}" />
<meta name="keywords" content="{{strip_tags($beritas->title)}}" />
<meta property="og:title" content="{{$beritas->title}} " />
<meta property="og:type" content="berita" />
<meta property="og:image"
    content="{{($beritas->img)?asset('backend/images/informasi/berita/'.$beritas->img):asset('backend/images/default.jpg')}}" />
@endsection
 ...
 -->
                ...
                <div class="flex-wr-s-s p-b-10">
                    <span class="f1-s-3 m-r-15">
                        <span>
                            <i class="fa fa-user"></i> {{$beritas->created_by}} |&nbsp;
                        </span>
                        <span>
                        ...
                        <span>
                            <i class="fa fa-eye"></i> {{$beritas->hit}} Dilihat |&nbsp;
                        </span>
                        <span>
            ...
            <div class="detail-content pb-4">
                ...
                <img src="{{($beritas->img)?asset('backend/images/informasi/berita/'.$beritas->img):asset('backend/images/default.jpg')}}" alt="{{$beritas->title}}"
            ...
            <!-- <div class="flex-s-s pt-2 pb-2">

								<span class="f1-s-12 cl5 mr-2">
								...
								<div class="flex-wr-s-s size-w-0">
									...
									<a href="#" class="f1-s-12">

										<span class="badge badge-secondary mr-1">Streetstyle</span>

									</a>

									<a href="#" class="f1-s-12">

										<span class="badge badge-secondary mr-1">Crafts</span>
 ...
 -->
            ...
            <div class="pb-2 mb-2">
                ...
                <form method="post" action="{{route('frontend.komentar')}}">
                    @csrf
                    <div class="row pb-2">
                        <input type="hidden" name="info_id" value="{{$beritas->id}}">
