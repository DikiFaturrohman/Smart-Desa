...
class SkkController extends Controller
{
    ...
    public function index()
    {
        try{
            if(empty(Auth::user()->desa_id)){
                ...
                $data['skk'] = SKK::where('desa_id',Auth::user()->desa_id)->orderBy('created_at','asc')->orderBy('status','asc')->get();
            }
    ...
    public function createProccess(Request $request)
    {
        try{
            ...
            $log = $this->suketLogNotifikasi($skk,'skk','Verifikasi','Pengajuan Surat Keterangan Kelahiran Telah di verifikasi Oleh Operator Desa','operator','terima');
            $logAdmin = $this->logNotifikasiAdmin($request->kasi_id,'Verifikasi','Verifikasi Surat Keterangan Kelahiran disetujui oleh operator desa ');
    ...
    public function verifikasiKades(Request $request)
    {
        try{
            ...
            if($signDokumen == 'berhasil'){
                ...
                $log = $this->suketLogNotifikasi($skk,'skk','Verifikasi','Pengajuan Surat Keterangan Kelahiran Telah di verifikasi Oleh Kepala Desa','kades','terima');
                $admin = $this->getAdmin('operator',Session::get('desa_id'));
                $logAdmin = $this->logNotifikasiAdmin($admin,'Verifikasi','Verifikasi Surat Keterangan Kelahiran disetujui oleh kepala desa');
    ...
    public function verifikasiSekdes(Request $request)
    {
        try{
            ...
            $log = $this->suketLogNotifikasi($skk,'skk','Verifikasi','Pengajuan Surat Keterangan Kelahiran Telah di verifikasi Oleh Sekretaris Desa','sekdes','terima');
            $admin = $this->getAdmin('kepala_desa',Session::get('desa_id'));
            $logAdmin = $this->logNotifikasiAdmin($admin,'Verifikasi','Verifikasi Surat Keterangan Kelahiran disetujui oleh sekretaris desa');
    ...
    public function verifikasiKasi(Request $request)
    {
        try{
            ...
            $log = $this->suketLogNotifikasi($skk,'skk','Verifikasi','Pengajuan Surat Keterangan Kelahiran Telah di verifikasi Oleh Kasi Desa','kasi','terima');
            $admin = $this->getAdmin('sekretaris_desa',Session::get('desa_id'));
            $logAdmin = $this->logNotifikasiAdmin($admin,'Verifikasi','Verifikasi Surat Keterangan Kelahiran disetujui oleh kasi desa');
    ...
    public function rejected(Request $request)
    {
        try{
            ...
            $log = $this->suketLogNotifikasi($skk,'skk','Penolakan',$request->pesan,'operator','tolak');
