...
use App\Actions\SkkCreateAction;
use App\Models\User;
use Auth;

class SkkCreate extends Component
{
    use WithFileUploads;
    use AutoNumber;
    ...
    public function store()
    {
        ...
        $namaFile = [
            'file_sk_kelahiran' =>  \Str::uuid().'.'.$this->file_sk_kelahiran->getClientOriginalExtension(),
            'file_surat_nikah' =>  \Str::uuid().'.'.$this->file_surat_nikah->getClientOriginalExtension(),
            'file_kk' => \Str::uuid().'.'.$this->file_kk->getClientOriginalExtension(),
            'file_ayah' => \Str::uuid().'.'.$this->file_ayah->getClientOriginalExtension(),
            'file_ibu' => \Str::uuid().'.'.$this->file_ibu->getClientOriginalExtension(),
        ];
        ...
        $skk = (new SkkCreateAction)->run($data);
        if(empty($skk)){
